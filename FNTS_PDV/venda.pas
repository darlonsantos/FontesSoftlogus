...
(*
  ...
  fl.Directory := '\Athenas\paf\dat\carga';
  fl.Refresh;
  fl.Update;
...
var
  ...
  scod_cupom: string;
begin
  Imprime_display('Aguarde! Cancelando cupom ' + sNumero_Cupom + '!', clYellow,
    tiAlerta);
...
//  pn_principal.DoubleBuffered := FALSE;
{$IFDEF DEBUG}
  bDebug := true;
{$ELSE}
  bDebug := false;
      ...
      begin
        ...
        begin
          if (ed_forma2.value > 0) and
            (ansiuppercase(cb_forma2.text) = ansiuppercase(lForma_Cartao[i]))
          then
          begin
            if (ed_forma3.value > 0) then
            begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            if (ed_forma1.value > 0) and
              (ansiuppercase(cb_forma1.text) = ansiuppercase(lForma_Cartao[i]))
            then
            begin
      ...
      begin
        ...
        begin
          ...
          if (ed_forma3.value > 0) and
            (ansiuppercase(cb_forma3.text) = ansiuppercase(lForma_Cartao[i]))
          then
          begin
            Imprime_display('TEF', CLWHITE, tiPgto);
            // armazenar o nome da forma de pagamento para CNFV
    ...
    begin
      ...
      if ed_troco.value > 0 then
        Imprime_display('Pago: R$ ' + formatfloat('###,###,##0.00',
          ...
          formatfloat('###,###,##0.00', ed_troco.value), CLWHITE, tiPgto)
      else
            ...
            begin
              ...
              begin
                ...
                frmmodulo.St_Abastecimento.ParamByName('codigo').asinteger :=
                  ...
                  .asinteger;
                frmmodulo.St_Abastecimento.ParamByName('data').AsDateTime :=
                  dData; // strtodate(ab.data);
