...
begin
  ...
  begin
    ...
    begin
      ...
      sArquivo := 'c:\siscom\s8\txt\CTP'+zerar(sECF_Serial,20)+'_'+somenteNumero(datetostr(dData_sistema))+
...
//         showmessage(cDataInicial+' '+cDataFinal);
  ...
  begin
    ...
    try
      if FileExists('C:\siscom\s8\exe\uDecoder\WIN_uDecoder.exe') then
      begin
        Executa_Programa('C:\siscom\s8\exe\uDecoder\WIN_uDecoder.exe', '', SW_SHOW);
