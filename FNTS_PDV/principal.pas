...
var
  ...
  lForma_Cheque, lForma_Crediario, lForma_Cartao, lForma_dinheiro,
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          Application.MessageBox
            ('Houve falha na leitura do registro da Balança!' +
        ...
        begin
          Application.MessageBox
            ('Houve falha na leitura do registro do teclado! ' +
            'Favor contactar o suporte!', 'Erro', mb_ok + mb_iconerror);
        end;
        Registro.CloseKey;
        (* ******** Final do TECLADO ************ *)
  ...
  begin
    ...
    lForma_Cartao.CommaText := frmmodulo.query.FieldByName
      ('forma_cartao').asstring;
