...
uses
  ...
  Dialogs, Grids, frxRich, DBAccess, IBC, MemDS, VirtualTable, CRBatchMove,
  DB, RxMemDS, frxClass, frxDBSet, frxDesgn, Menus, ImgList, StdCtrls,
  DBCtrls, ExtCtrls, Collection, AdvGlowButton,
  TFlatPanelUnit, Wwdbigrd, Wwdbgrid, PageView, Mask, RzEdit, RzBtnEdt,
