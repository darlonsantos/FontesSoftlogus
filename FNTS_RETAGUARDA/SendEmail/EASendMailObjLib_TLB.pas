...
// $Rev: 31855 $
// File generated on 26/02/2012 02:38:38 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Documents and Settings\Solivan\Desktop\Envio Email NFe\Email SMTP\Win32\Debug\SendMail.dll (1)
...
// Errors:
//   Error creating palette bitmap of (TMail) : Server C:\Documents and Settings\Solivan\Desktop\Envio Email NFe\Email SMTP\Win32\Debug\SendMail.dll contains no icons
//   Error creating palette bitmap of (TFastSender) : Server C:\Documents and Settings\Solivan\Desktop\Envio Email NFe\Email SMTP\Win32\Debug\SendMail.dll contains no icons
//   Error creating palette bitmap of (TCertificate) : Server C:\Documents and Settings\Solivan\Desktop\Envio Email NFe\Email SMTP\Win32\Debug\SendMail.dll contains no icons
//   Error creating palette bitmap of (TCertificateCollection) : Server C:\Documents and Settings\Solivan\Desktop\Envio Email NFe\Email SMTP\Win32\Debug\SendMail.dll contains no icons
// ************************************************************************ //
// *************************************************************************//
// NOTE:                                                                      
...
// *********************************************************************//
  IMail = interface(IDispatch)
    ...
    procedure AddCalendar(const Content: WideString; const CalendarMethod: WideString); safecall;
    procedure ClearCalendar; safecall;
...
// *********************************************************************//
  IMailDisp = dispinterface
    ...
    procedure AddCalendar(const Content: WideString; const CalendarMethod: WideString); dispid 99;
    procedure ClearCalendar; dispid 100;
  end;
...
{$ENDIF}
  ...
  public
    ...
    procedure AddCalendar(const Content: WideString; const CalendarMethod: WideString);
...
procedure TMail.AddCalendar(const Content: WideString; const CalendarMethod: WideString);
begin
  DefaultInterface.AddCalendar(Content, CalendarMethod);
end;

procedure TMail.ClearCalendar;
begin
  DefaultInterface.ClearCalendar;
end;
