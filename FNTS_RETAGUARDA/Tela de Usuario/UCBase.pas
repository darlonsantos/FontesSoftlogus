...
uses
  VCL.ActnList, VCL.ActnMan, VCL.ActnMenus, Classes, VCL.Controls, DB, VCL.ExtActns, VCL.Forms, VCL.Graphics,
  VCL.Menus, VCL.StdCtrls, SysUtils,
  {.$IFDEF DELPHI5_UP}
  Variants,
  {.$ENDIF}
  Windows,
...
var
  ...
  retorno: Integer;
begin
  TfrmLoginWindow(FFormLogin).btOKClic(Sender); { By Cleilson Sousa }
