...
uses
  ...
  RxMemDS, frxClass, frxDBSet, Grids, DBGrids, RzPanel, Data.FMTBcd, Data.SqlExpr;
...
type
  Tfrmexporta = class(TForm)
    ...
    QrySIntegra_old: TZQuery;
    QrySintegra_D_old: TZQuery;
    zquery1_old: TZQuery;
    DataSource1: TDataSource;
    QRNOTA_old: TZQuery;
    QRITEM_old: TZQuery;
    qrsaida_temp_old: TZQuery;
    qrsaida_old: TZQuery;
    QRSAIDA_ITEM_old: TZQuery;
    QrAdiciona_item_old: TZQuery;
    qrentrada_old: TZQuery;
    qritem2_old: TZQuery;
    qrentrada_temp_old: TZQuery;
    qrentrada_item_old: TZQuery;
    RichEdit2: TRichEdit;
    ...
    fslog: TfrxDBDataset;
    qrfaturas_OLD: TZQuery;
    qrreducaoz_OLD: TZQuery;
    ...
    qrentrada_oldCODIGO: TWideStringField;
    qrentrada_oldNUMERO: TWideStringField;
    qrentrada_oldCODEMPRESA: TWideStringField;
    qrentrada_oldCODFORNECEDOR: TWideStringField;
    qrentrada_oldMODELO: TWideStringField;
    qrentrada_oldESPECIE: TWideStringField;
    qrentrada_oldSERIE: TWideStringField;
    qrentrada_oldCFOP: TWideStringField;
    qrentrada_oldDATA_EMISSAO: TDateTimeField;
    qrentrada_oldDATA_LANCAMENTO: TDateTimeField;
    qrentrada_oldCONF_BASEICMS: TFloatField;
    qrentrada_oldCONF_VALORICMS: TFloatField;
    qrentrada_oldCONF_BASESUB: TFloatField;
    qrentrada_oldCONF_VALORSUB: TFloatField;
    qrentrada_oldCONF_FRETE: TFloatField;
    qrentrada_oldCONF_SEGURO: TFloatField;
    qrentrada_oldCONF_OUTRAS: TFloatField;
    qrentrada_oldCONF_IPI: TFloatField;
    qrentrada_oldCONF_DESCONTO: TFloatField;
    qrentrada_oldCONF_TOTALPRODUTOS: TFloatField;
    qrentrada_oldCONF_TOTALNOTA: TFloatField;
    qrentrada_oldCONF_ICMSRETIDO: TFloatField;
    qrentrada_oldCONF_ICMSREDITO_PERC: TFloatField;
    qrentrada_oldBASE_ICMS: TFloatField;
    qrentrada_oldVALOR_ICMS: TFloatField;
    qrentrada_oldBASE_SUB: TFloatField;
    qrentrada_oldVALOR_SUB: TFloatField;
    qrentrada_oldFRETE: TFloatField;
    qrentrada_oldSEGURO: TFloatField;
    qrentrada_oldOUTRAS: TFloatField;
    qrentrada_oldIPI: TFloatField;
    qrentrada_oldDESCONTO: TFloatField;
    qrentrada_oldTOTAL_PRODUTOS: TFloatField;
    qrentrada_oldTOTAL_NOTA: TFloatField;
    qrentrada_oldTRANSP_NOME: TWideStringField;
    qrentrada_oldTRANSP_FRETE: TWideStringField;
    qrentrada_oldTRANSP_PLACA: TWideStringField;
    qrentrada_oldTRANSP_PLACAUF: TWideStringField;
    qrentrada_oldTRANSP_IE: TWideStringField;
    qrentrada_oldTRANSP_CNPJ: TWideStringField;
    qrentrada_oldTRANSP_ENDERECO: TWideStringField;
    qrentrada_oldTRANSP_CIDADE: TWideStringField;
    qrentrada_oldTRANSP_UF: TWideStringField;
    qrentrada_oldTRANSP_QTDE: TFloatField;
    qrentrada_oldTRANSP_ESPECIE: TWideStringField;
    qrentrada_oldTRANSP_MARCA: TWideStringField;
    qrentrada_oldTRANSP_NUMERO: TWideStringField;
    qrentrada_oldTRANSP_PESOBRUTO: TFloatField;
    qrentrada_oldTRANSP_PESOLIQUIDO: TFloatField;
    qrentrada_oldOBS1: TWideStringField;
    qrentrada_oldOBS2: TWideStringField;
    qrentrada_oldOBS3: TWideStringField;
    qrentrada_oldOBS4: TWideStringField;
    qrentrada_oldOBS5: TWideStringField;
    qrentrada_oldOBS6: TWideStringField;
    qrentrada_oldOBS7: TWideStringField;
    qrentrada_oldSITUACAO: TIntegerField;
    qrentrada_oldITENS: TIntegerField;
    qrentrada_oldTIPO: TWideStringField;
    qrentrada_oldNOTA_FISCAL: TWideStringField;
    qrentrada_oldVALOR_MERCADORIAS: TFloatField;
    qrentrada_oldCODREMETENTE: TWideStringField;
    qrentrada_oldICMS_ISENTO: TFloatField;
    qrentrada_oldICMS_OUTRAS: TFloatField;
    qrentrada_oldDESCONTO_INCIDENTE: TIntegerField;
    qrentrada_oldITEM_FRETE_VALOR: TFloatField;
    qrentrada_oldITEM_FRETE_BASE: TFloatField;
    qrentrada_oldITEM_FRETE_ALIQUOTA: TFloatField;
    qrentrada_oldITEM_FRETE_ICMS: TFloatField;
    qrentrada_oldITEM_SEGURO_VALOR: TFloatField;
    qrentrada_oldITEM_SEGURO_BASE: TFloatField;
    qrentrada_oldITEM_SEGURO_ALIQUOTA: TFloatField;
    qrentrada_oldITEM_SEGURO_ICMS: TFloatField;
    qrentrada_oldITEM_PIS_VALOR: TFloatField;
    qrentrada_oldITEM_PIS_BASE: TFloatField;
    qrentrada_oldITEM_PIS_ALIQUOTA: TFloatField;
    qrentrada_oldITEM_PIS_ICMS: TFloatField;
    qrentrada_oldITEM_COMPLEMENTO_VALOR: TFloatField;
    qrentrada_oldITEM_COMPLEMENTO_BASE: TFloatField;
    qrentrada_oldITEM_COMPLEMENTO_ALIQUOTA: TFloatField;
    qrentrada_oldITEM_COMPLEMENTO_ICMS: TFloatField;
    qrentrada_oldITEM_SERVICO_VALOR: TFloatField;
    qrentrada_oldITEM_SERVICO_BASE: TFloatField;
    qrentrada_oldITEM_SERVICO_ALIQUOTA: TFloatField;
    qrentrada_oldITEM_SERVICO_ICMS: TFloatField;
    qrentrada_oldITEM_OUTRAS_VALOR: TFloatField;
    qrentrada_oldITEM_OUTRAS_BASE: TFloatField;
    qrentrada_oldITEM_OUTRAS_ALIQUOTA: TFloatField;
    qrentrada_oldITEM_OUTRAS_ICMS: TFloatField;
    qrentrada_oldITEM_ESPECIAL_TOTAL: TFloatField;
    qrentrada_oldITEM_ESPECIAL_VALOR: TFloatField;
    qrentrada_oldBASEICMS_PRODUTOS: TIntegerField;
    qrentrada_oldCONF_ITEM_ESPECIAL: TFloatField;
    qrentrada_oldOBS8: TWideStringField;
    qrentrada_oldCREDITO_ICMS: TFloatField;
    qrentrada_oldPIS: TFloatField;
    qrentrada_oldCOFINS: TFloatField;
    qrentrada_oldOPERACAO: TWideStringField;
    qrentrada_oldINTEGRACAO: TIntegerField;
    qrentrada_oldAPROVEITA_CREDITO_ICMS: TWideStringField;
    qrentrada_oldCHAVE: TWideStringField;
    qrentrada_oldCODIGO_1: TWideStringField;
    qrentrada_oldNOME: TWideStringField;
    qrentrada_oldCNPJ: TWideStringField;
    qrentrada_oldIE: TWideStringField;
    qrentrada_oldUF: TWideStringField;
    qrentrada_oldCOD_MUNICIPIO_IBGE: TWideStringField;
    qrsaida_oldCODIGO: TWideStringField;
    qrsaida_oldNUMERO: TWideStringField;
    qrsaida_oldCFOP: TWideStringField;
    qrsaida_oldDATA: TDateTimeField;
    qrsaida_oldCODCLIENTE: TWideStringField;
    qrsaida_oldVALOR_PRODUTOS: TFloatField;
    qrsaida_oldTOTAL_NOTA: TFloatField;
    qrsaida_oldBASE_CALCULO: TFloatField;
    qrsaida_oldVALOR_ICMS: TFloatField;
    qrsaida_oldBASE_SUB: TFloatField;
    qrsaida_oldICMS_SUB: TFloatField;
    qrsaida_oldFRETE: TFloatField;
    qrsaida_oldSEGURO: TFloatField;
    qrsaida_oldOUTRAS_DESPESAS: TFloatField;
    qrsaida_oldVALOR_TOTAL_IPI: TFloatField;
    qrsaida_oldITENS: TIntegerField;
    qrsaida_oldDESCONTO: TFloatField;
    qrsaida_oldCODTRANSPORTADOR: TWideStringField;
    qrsaida_oldFRETE_CONTA: TIntegerField;
    qrsaida_oldPLACA: TWideStringField;
    qrsaida_oldPLACA_UF: TWideStringField;
    qrsaida_oldVOL_QTDE: TFloatField;
    qrsaida_oldVOL_ESPECIE: TWideStringField;
    qrsaida_oldVOL_MARCA: TWideStringField;
    qrsaida_oldVOL_NUMERO: TWideStringField;
    qrsaida_oldPESO_LIQUIDO: TFloatField;
    qrsaida_oldPESO_BRUTO: TFloatField;
    qrsaida_oldSITUACAO: TIntegerField;
    qrsaida_oldMOTIVO: TWideStringField;
    qrsaida_oldFATURAMENTO_DATA1: TDateTimeField;
    qrsaida_oldFATURAMENTO_DATA2: TDateTimeField;
    qrsaida_oldFATURAMENTO_DATA3: TDateTimeField;
    qrsaida_oldFATURAMENTO_DATA4: TDateTimeField;
    qrsaida_oldFATURAMENTO_NUMERO1: TWideStringField;
    qrsaida_oldFATURAMENTO_NUMERO2: TWideStringField;
    qrsaida_oldFATURAMENTO_NUMERO3: TWideStringField;
    qrsaida_oldFATURAMENTO_NUMERO4: TWideStringField;
    qrsaida_oldFATURAMENTO_VALOR1: TFloatField;
    qrsaida_oldFATURAMENTO_VALOR2: TFloatField;
    qrsaida_oldFATURAMENTO_VALOR3: TFloatField;
    qrsaida_oldFATURAMENTO_VALOR4: TFloatField;
    qrsaida_oldCODFILIAL: TWideStringField;
    qrsaida_oldOBS1: TWideStringField;
    qrsaida_oldOBS2: TWideStringField;
    qrsaida_oldOBS3: TWideStringField;
    qrsaida_oldINF1: TWideStringField;
    qrsaida_oldINF2: TWideStringField;
    qrsaida_oldINF3: TWideStringField;
    qrsaida_oldINF4: TWideStringField;
    qrsaida_oldINF5: TWideStringField;
    qrsaida_oldDATA_SAIDA: TDateTimeField;
    qrsaida_oldHORA: TWideStringField;
    qrsaida_oldSITUACAO_A: TWideStringField;
    qrsaida_oldMODELO_NF: TWideStringField;
    qrsaida_oldSERIE_NF: TWideStringField;
    qrsaida_oldVALOR_ISENTO_ICMS: TFloatField;
    qrsaida_oldALIQUOTA_ICMS: TFloatField;
    qrsaida_oldSIT: TWideStringField;
    qrsaida_oldCODLANCAMENTO: TWideStringField;
    qrsaida_oldMOVIMENTO: TWideStringField;
    qrsaida_oldBAIXA_ESTOQUE: TWideStringField;
    qrsaida_oldTIPO: TWideStringField;
    qrsaida_oldOS_COD1: TWideStringField;
    qrsaida_oldOS_COD2: TWideStringField;
    qrsaida_oldOS_COD3: TWideStringField;
    qrsaida_oldOS_COD4: TWideStringField;
    qrsaida_oldOS_COD5: TWideStringField;
    qrsaida_oldOS_COD6: TWideStringField;
    qrsaida_oldOS_SERV1: TWideStringField;
    qrsaida_oldOS_SERV2: TWideStringField;
    qrsaida_oldOS_SERV3: TWideStringField;
    qrsaida_oldOS_SERV4: TWideStringField;
    qrsaida_oldOS_SERV5: TWideStringField;
    qrsaida_oldOS_SERV6: TWideStringField;
    qrsaida_oldOS_COMP1: TWideStringField;
    qrsaida_oldOS_COMP2: TWideStringField;
    qrsaida_oldOS_COMP3: TWideStringField;
    qrsaida_oldOS_COMP4: TWideStringField;
    qrsaida_oldOS_COMP5: TWideStringField;
    qrsaida_oldOS_COMP6: TWideStringField;
    qrsaida_oldOS_QTDE1: TFloatField;
    qrsaida_oldOS_QTDE2: TFloatField;
    qrsaida_oldOS_QTDE3: TFloatField;
    qrsaida_oldOS_QTDE4: TFloatField;
    qrsaida_oldOS_QTDE5: TFloatField;
    qrsaida_oldOS_QTDE6: TFloatField;
    qrsaida_oldOS_UNIT1: TFloatField;
    qrsaida_oldOS_UNIT2: TFloatField;
    qrsaida_oldOS_UNIT3: TFloatField;
    qrsaida_oldOS_UNIT4: TFloatField;
    qrsaida_oldOS_UNIT5: TFloatField;
    qrsaida_oldOS_UNIT6: TFloatField;
    qrsaida_oldOS_TOTAL1: TFloatField;
    qrsaida_oldOS_TOTAL2: TFloatField;
    qrsaida_oldOS_TOTAL3: TFloatField;
    qrsaida_oldOS_TOTAL4: TFloatField;
    qrsaida_oldOS_TOTAL5: TFloatField;
    qrsaida_oldOS_TOTAL6: TFloatField;
    qrsaida_oldOS_ISS: TFloatField;
    qrsaida_oldOS_TOTAL_GERAL: TFloatField;
    qrsaida_oldOS_TOTAL_ISS: TFloatField;
    qrsaida_oldDESCONTO_ITEM: TFloatField;
    qrsaida_oldOBS4: TWideStringField;
    qrsaida_oldOBS5: TWideStringField;
    qrsaida_oldCODIGOMODELO: TWideStringField;
    qrsaida_oldCUSTO_VENDA: TWideStringField;
    qrsaida_oldFAT_FORMA_PGTO: TWideStringField;
    qrsaida_oldFAT_CONDI_PGTO: TWideStringField;
    qrsaida_oldFAT_QTDE_PRESTACAO: TIntegerField;
    qrsaida_oldFAT_GERAR_RECEBER: TIntegerField;
    qrsaida_oldFAT_GERAR_DUPLICATA: TIntegerField;
    qrsaida_oldPIS: TFloatField;
    qrsaida_oldCOFINS: TFloatField;
    qrsaida_oldFAT_TIPO: TIntegerField;
    qrsaida_oldCODVENDEDOR: TWideStringField;
    qrsaida_oldOPERACAO: TWideStringField;
    qrsaida_oldINTEGRACAO: TIntegerField;
    qrsaida_oldNFE_SITUACAO: TIntegerField;
    qrsaida_oldNFE_XML: TWideStringField;
    qrsaida_oldVAREJO_ATACADO: TWideStringField;
    qrsaida_oldINDUSTRIALIZACAO: TWideStringField;
    qrsaida_oldPERDA: TWideStringField;
    qrsaida_oldFATURAMENTO_DATA5: TDateTimeField;
    qrsaida_oldFATURAMENTO_DATA6: TDateTimeField;
    qrsaida_oldFATURAMENTO_NUMERO5: TWideStringField;
    qrsaida_oldFATURAMENTO_NUMERO6: TWideStringField;
    qrsaida_oldFATURAMENTO_VALOR5: TFloatField;
    qrsaida_oldFATURAMENTO_VALOR6: TFloatField;
    qrsaida_oldFATURAMENTO_DATA7: TDateTimeField;
    qrsaida_oldFATURAMENTO_DATA8: TDateTimeField;
    qrsaida_oldFATURAMENTO_DATA9: TDateTimeField;
    qrsaida_oldFATURAMENTO_NUMERO7: TWideStringField;
    qrsaida_oldFATURAMENTO_NUMERO8: TWideStringField;
    qrsaida_oldFATURAMENTO_NUMERO9: TWideStringField;
    qrsaida_oldFATURAMENTO_VALOR7: TFloatField;
    qrsaida_oldFATURAMENTO_VALOR8: TFloatField;
    qrsaida_oldFATURAMENTO_VALOR9: TFloatField;
    qrsaida_oldCHAVE: TWideStringField;
    qrsaida_oldNATUREZA: TWideStringField;
    qrsaida_oldCODIGO_1: TWideStringField;
    qrsaida_oldNOME: TWideStringField;
    qrsaida_oldCPF: TWideStringField;
    qrsaida_oldRG: TWideStringField;
    qrsaida_oldUF: TWideStringField;
    qrsaida_oldCOD_MUNICIPIO_IBGE: TWideStringField;
    qrfaturas_OLDCODIGO: TWideStringField;
    qrfaturas_OLDDATA_EMISSAO: TDateTimeField;
    qrfaturas_OLDDATA_VENCIMENTO: TDateTimeField;
    qrfaturas_OLDDATA_PAGAMENTO: TDateTimeField;
    qrfaturas_OLDCODCONTA: TWideStringField;
    qrfaturas_OLDCODFORNECEDOR: TWideStringField;
    qrfaturas_OLDVALOR: TFloatField;
    qrfaturas_OLDVALORPAGO: TFloatField;
    qrfaturas_OLDLIQUIDO: TFloatField;
    qrfaturas_OLDDESCONTO: TFloatField;
    qrfaturas_OLDACRESCIMO: TFloatField;
    qrfaturas_OLDDOCUMENTO: TWideStringField;
    qrfaturas_OLDNOTAFISCAL: TWideStringField;
    qrfaturas_OLDHISTORICO: TWideStringField;
    qrfaturas_OLDC: TWideStringField;
    qrfaturas_OLDE: TWideStringField;
    qrfaturas_OLDFILTRO: TIntegerField;
    qrfaturas_OLDESPECIE: TWideStringField;
    qrfaturas_OLDSITUACAO: TIntegerField;
    qrfaturas_OLDCODNOTA: TWideStringField;
    qrfaturas_OLDMOVIMENTO: TIntegerField;
    qrfaturas_OLDCODCAIXA: TWideStringField;
    qrfaturas_OLDCODIGO_1: TWideStringField;
    qrfaturas_OLDNUMERO: TWideStringField;
    qrfaturas_OLDCODFORNECEDOR_1: TWideStringField;
    qrfaturas_OLDDATA_LANCAMENTO: TDateTimeField;
    qrfaturas_OLDMODELO: TWideStringField;
    qrfaturas_OLDSERIE: TWideStringField;
    qrfaturas_OLDESPECIE_1: TWideStringField;
    qrfaturas_OLDCODIGO_2: TWideStringField;
    qrfaturas_OLDNOME: TWideStringField;
    qrfaturas_OLDCNPJ: TWideStringField;
    qrfaturas_OLDIE: TWideStringField;
    qrfaturas_OLDUF: TWideStringField;
    qrfaturas_OLDCOD_MUNICIPIO_IBGE: TWideStringField;
    qrreducaoz_OLDID: TIntegerField;
    qrreducaoz_OLDMOVIMENTO: TWideStringField;
    qrreducaoz_OLDCODIGO_EMPRESA: TIntegerField;
    qrreducaoz_OLDOBS1: TWideStringField;
    qrreducaoz_OLDCNPJ: TWideStringField;
    qrreducaoz_OLDIE: TWideStringField;
    qrreducaoz_OLDUF: TWideStringField;
    qrreducaoz_OLDCODIGO_CLIENTE: TIntegerField;
    qrreducaoz_OLDCNPJ_CLIENTE: TWideStringField;
    qrreducaoz_OLDIE_CLIENTE: TWideStringField;
    qrreducaoz_OLDUF_CLIENTE: TWideStringField;
    qrreducaoz_OLDCFOP: TWideStringField;
    qrreducaoz_OLDCOD_SINTEGRA_R60: TWideStringField;
    qrreducaoz_OLDDATA_EMISSAO: TDateTimeField;
    qrreducaoz_OLDNRO_SERIE_EQP: TWideStringField;
    qrreducaoz_OLDNRO_ORDEM_EQP: TIntegerField;
    qrreducaoz_OLDMODELO_DOC: TWideStringField;
    qrreducaoz_OLDNRO_CONTADOR_INICIO: TIntegerField;
    qrreducaoz_OLDNRO_CONTADOR_FIM: TIntegerField;
    qrreducaoz_OLDNRO_CONTADOR_Z: TIntegerField;
    qrreducaoz_OLDNRO_DOC_FISCAL: TIntegerField;
    qrreducaoz_OLDNRO_ITENS: TIntegerField;
    qrreducaoz_OLDCONTADOR_REINICIO: TIntegerField;
    qrreducaoz_OLDVALOR_VENDA_BRUTA: TFloatField;
    qrreducaoz_OLDVALOR_TOTAL_GERAL: TFloatField;
    qrreducaoz_OLDBRANCOS: TWideStringField;
    qrreducaoz_OLDDATAHORA_RECEBIMENTO: TDateTimeField;
    qrreducaoz_OLDMODELO_NF: TWideStringField;
    qrreducaoz_OLDDATAHORA_INI: TDateTimeField;
    qrreducaoz_OLDDATAHORA_FIM: TDateTimeField;
    qrreducaoz_OLDCANCELAMENTO: TFloatField;
    qrreducaoz_OLDDESCONTO: TFloatField;
    qrreducaoz_OLDISSQN: TFloatField;
    qrreducaoz_OLDSUBSTITUICAO_TRIBUTARIA: TFloatField;
    qrreducaoz_OLDISENTO: TFloatField;
    qrreducaoz_OLDNAO_INCIDENCIA: TFloatField;
    qrreducaoz_OLDACRESCIMO_IOF: TFloatField;
    qrreducaoz_OLDALIQUOTA01: TFloatField;
    qrreducaoz_OLDALIQUOTA02: TFloatField;
    qrreducaoz_OLDALIQUOTA03: TFloatField;
    qrreducaoz_OLDALIQUOTA04: TFloatField;
    qrreducaoz_OLDALIQUOTA05: TFloatField;
    qrreducaoz_OLDBASE01: TFloatField;
    qrreducaoz_OLDBASE02: TFloatField;
    qrreducaoz_OLDBASE03: TFloatField;
    qrreducaoz_OLDBASE04: TFloatField;
    qrreducaoz_OLDBASE05: TFloatField;
    qrreducaoz_OLDVALOR_TPARCIAL01: TFloatField;
    qrreducaoz_OLDVALOR_TPARCIAL02: TFloatField;
    qrreducaoz_OLDVALOR_TPARCIAL03: TFloatField;
    qrreducaoz_OLDVALOR_TPARCIAL04: TFloatField;
    qrreducaoz_OLDVALOR_TPARCIAL05: TFloatField;
    qrreducaoz_OLDBRANCOS_60A01: TWideStringField;
    qrreducaoz_OLDBRANCOS_60A02: TWideStringField;
    qrreducaoz_OLDBRANCOS_60A03: TWideStringField;
    qrreducaoz_OLDBRANCOS_60A04: TWideStringField;
    qrreducaoz_OLDBRANCOS_60A05: TWideStringField;
    qrreducaoz_OLDTOTAL_INICIO_DIA: TFloatField;
    qrreducaoz_OLDTOTAL_FINAL_DIA: TFloatField;
    qrreducaoz_OLDTOTAL_DIA: TFloatField;
    qrreducaoz_OLDOBSERVACAO: TWideStringField;
    qrreducaoz_OLDVALOR_VENDA_LIQUIDA: TFloatField;
    qrreducaoz_OLDNRO_CONTADOR_CANCELAMENTO: TIntegerField;
    qrreducaoz: TSQLQuery;
    ...
    qrentrada_temp: TSQLQuery;
    qritem2: TSQLQuery;
    QrAdiciona_item: TSQLQuery;
    zquery1: TSQLQuery;
    QrySIntegra: TSQLQuery;
    QrySintegra_D: TSQLQuery;
    query: TSQLQuery;
    QRNOTA: TSQLQuery;
    qrsaida_temp: TSQLQuery;
    QRITEM: TSQLQuery;
    QRSAIDA_ITEM: TSQLQuery;
...
begin
  ...
  begin
    fxlog.LoadFromFile('\Softlogus\server\rel\F000193.fr3');
    fxlog.ShowReport;
  end;
  rxlog.First;
