...
uses
  ...
  LMDGraphicControl, LMDScrollText, pngimage, EAppProt, AdvReflectionImage;
...
type
  ...
  TfrmPrincipal = class(TForm)                         
    ...
    AdvCadastros: TAdvPopupMenu;
    CadastroEmpresa1: TMenuItem;
    CadastrodeClientes1: TMenuItem;
    CadastrodeFornecedores1: TMenuItem;
    CadastrodeUsurios1: TMenuItem;
    CaixaOperadores1: TMenuItem;
    CadastrodeFuncionrios1: TMenuItem;
    DiversosCadastros1: TMenuItem;
    Outros1: TMenuItem;
    CadastroFiscais1: TMenuItem;
    N5: TMenuItem;
    Veculos2: TMenuItem;
    ...
    ImageBarra: TImageList;
    AdvEstoque: TAdvPopupMenu;
    CadastrodeProdutos1: TMenuItem;
    CadastrodeGrupos1: TMenuItem;
    CadastrodeMarcas1: TMenuItem;
    EntradadeProdutos1: TMenuItem;
    ConsultadePreo1: TMenuItem;
    AdvMovimentacao: TAdvPopupMenu;
    OramentoDiversos1: TMenuItem;
    CadastrodeOrdemdeServio1: TMenuItem;
    NotasDiversasdeVendas1: TMenuItem;
    NotaFiscalEletronica201: TMenuItem;
    MovimentoDiriodeCupom1: TMenuItem;
    GeraoSintegra1: TMenuItem;
    GeraoSpedFiscal1: TMenuItem;
    AdvFinanceiro: TAdvPopupMenu;
    ControledeCheques1: TMenuItem;
    ContasRecebimentos1: TMenuItem;
    ControledeCaixa1: TMenuItem;
    ContasaPagamentos1: TMenuItem;
    ImageBarra2: TImageList;
    ttt1: TMenuItem;
    ...
    Vendas1: TMenuItem;
    AdRelatorios: TAdvPopupMenu;
    AdConfiguracoes: TAdvPopupMenu;
    ParametrizaodoSistema1: TMenuItem;
    AgendadeContato1: TMenuItem;
    RecuperarBackupdoSistema1: TMenuItem;
    FazerBackupdoSistema1: TMenuItem;
    RelatoriodeContasaPagar1: TMenuItem;
    RelatoriodeContasaReceber1: TMenuItem;
    RelatoriodeOrdemdeServio1: TMenuItem;
    RelatoriodeVendasDiversas1: TMenuItem;
    RelatoriodeCaixa1: TMenuItem;
    RelatoriodeProdutos1: TMenuItem;
    RelatoriodeClientes1: TMenuItem;
    RelatoriodeFornecedores1: TMenuItem;
    RelatoriodeFluxodeCaixa1: TMenuItem;
    ImageList3: TImageList;
    AdvToolBarPager11: TAdvPage;
    AdvEmpresa: TAdvGlowButton;
    AdvFornecedor: TAdvGlowButton;
    AdvUsuario: TAdvGlowButton;
    AdvCaixaOperador: TAdvGlowButton;
    AdvFuncionario: TAdvGlowButton;
    AdvCaDiverso: TAdvGlowButton;
    AdvCadFiscal: TAdvGlowButton;
    AdvClientes: TAdvGlowButton;
    AdvToolBarPager12: TAdvPage;
    AdvProduto: TAdvGlowButton;
    AdvGrupo: TAdvGlowButton;
    AdvMarca: TAdvGlowButton;
    AdvEntrada: TAdvGlowButton;
    AdvConsultaPreco: TAdvGlowButton;
    AdvToolBarPager13: TAdvPage;
    AdvOrcamento: TAdvGlowButton;
    AdvOrdemServico: TAdvGlowButton;
    AdvNotaServico: TAdvGlowButton;
    AdvConsultaNota: TAdvGlowButton;
    AdvNotaEletronica: TAdvGlowButton;
    AdvMovCupom: TAdvGlowButton;
    AdvSintegra: TAdvGlowButton;
    AdfSped: TAdvGlowButton;
    AdvPage1: TAdvPage;
    AdvCheque: TAdvGlowButton;
    AdvCReceber: TAdvGlowButton;
    AdvCPagar: TAdvGlowButton;
    AdvCaixa: TAdvGlowButton;
    AdvPage2: TAdvPage;
    AdvPage3: TAdvPage;
    AdvPage4: TAdvPage;
    AdvMenu: TAdvToolBarPager;
    pop_posto: TAdvPopupMenu;
    anques1: TMenuItem;
    Bombas1: TMenuItem;
    Bicos1: TMenuItem;
    AdvPosto: TAdvGlowButton;
    Combustiveis1: TMenuItem;
    N9: TMenuItem;
    LanaEncerrantes1: TMenuItem;
    N10: TMenuItem;
    LMC1: TMenuItem;
    AberturaEncerramento1: TMenuItem;
    LMC2: TMenuItem;
    AdvGlowButton1: TAdvGlowButton;
    pop_credito: TAdvPopupMenu;
    Lana1: TMenuItem;
    Baixa2: TMenuItem;
    Relatrio1: TMenuItem;
    Impresso1: TMenuItem;
    ...
    AdvToolBarOfficeStyler3: TAdvToolBarOfficeStyler;
    AdvRelCpag: TAdvGlowButton;
    AdvRelCrec: TAdvGlowButton;
    AdvRelOs: TAdvGlowButton;
    AdvRelMovCx: TAdvGlowButton;
    AdvRelFluxo: TAdvGlowButton;
    AdvRelVendaDiv: TAdvGlowButton;
    AdvRelMovProd: TAdvGlowButton;
    AdvRelForn: TAdvGlowButton;
    AdvRelCli: TAdvGlowButton;
    AdvParam: TAdvGlowButton;
    AdvFazBkp: TAdvGlowButton;
    AdvRecBkp: TAdvGlowButton;
    AdvGlowButton6: TAdvGlowButton;
    AdvGlowButton7: TAdvGlowButton;
    AdvCalender: TAdvGlowButton;
    AdvGlowButton3: TAdvGlowButton;
    AdvGlowButton2: TAdvGlowButton;
    pfundo: TFlatPanel;
    AdvImgFarma: TAdvReflectionImage;
    AdvImgPadrao: TAdvReflectionImage;
    AdvImgMercado: TAdvReflectionImage;
    Memo1: TMemo;
    pBackup: TPanel;
    RzPanel1: TRzPanel;
    ...
    procedure AdPedidoDistribuidoraClick(Sender: TObject);
    ...
    procedure AdvPostoClick(Sender: TObject);
    ...
    procedure AdContaFlexClick(Sender: TObject);
    procedure spFecharClick(Sender: TObject);
    procedure CadastroEmpresa1Click(Sender: TObject);
    ...
    procedure CaixaOperadores1Click(Sender: TObject);
    ...
    procedure tt1Click(Sender: TObject);
    ...
    procedure CadastrodeGrupos1Click(Sender: TObject);
    procedure CadastrodeMarcas1Click(Sender: TObject);
    procedure EntradadeProdutos1Click(Sender: TObject);
    procedure ConsultadePreo1Click(Sender: TObject);
    procedure OramentoDiversos1Click(Sender: TObject);
    procedure CadastrodeOrdemdeServio1Click(Sender: TObject);
    procedure NotasDiversasdeVendas1Click(Sender: TObject);
    procedure MovimentoDiriodeCupom1Click(Sender: TObject);
    procedure GeraoSintegra1Click(Sender: TObject);
    procedure GeraoSpedFiscal1Click(Sender: TObject);
    ...
    procedure ContasRecebimentos1Click(Sender: TObject);
    procedure ControledeCaixa1Click(Sender: TObject);
    procedure ContasaPagamentos1Click(Sender: TObject);
    procedure Vendas1Click(Sender: TObject);
    procedure ParametrizaodoSistema1Click(Sender: TObject);
    procedure AgendadeContato1Click(Sender: TObject);
    procedure RecuperarBackupdoSistema1Click(Sender: TObject);
    procedure FazerBackupdoSistema1Click(Sender: TObject);
    procedure RelatoriodeContasaPagar1Click(Sender: TObject);
    procedure RelatoriodeContasaReceber1Click(Sender: TObject);
    procedure RelatoriodeOrdemdeServio1Click(Sender: TObject);
    procedure RelatoriodeVendasDiversas1Click(Sender: TObject);
    procedure RelatoriodeCaixa1Click(Sender: TObject);
    procedure RelatoriodeProdutos1Click(Sender: TObject);
    procedure RelatoriodeClientes1Click(Sender: TObject);
    procedure RelatoriodeFornecedores1Click(Sender: TObject);
    procedure RelatoriodeFluxodeCaixa1Click(Sender: TObject);
    procedure SpeedButton1Click(Sender: TObject);
    procedure AdvSairClick(Sender: TObject);
    procedure AdvEmpresaClick(Sender: TObject);
    procedure AdvClientesClick(Sender: TObject);
    procedure AdvFornecedorClick(Sender: TObject);
    procedure AdvCaixaOperadorClick(Sender: TObject);
    procedure AdvFuncionarioClick(Sender: TObject);
    procedure AdvProdutoClick(Sender: TObject);
    procedure AdvGrupoClick(Sender: TObject);
    procedure AdvMarcaClick(Sender: TObject);
    procedure AdvEntradaClick(Sender: TObject);
    procedure AdvConsultaPrecoClick(Sender: TObject);
    procedure AdvOrcamentoClick(Sender: TObject);
    procedure AdvOrdemServicoClick(Sender: TObject);
    procedure AdvNotaServicoClick(Sender: TObject);
    procedure AdvConsultaNotaClick(Sender: TObject);
    procedure AdvNotaEletronicaClick(Sender: TObject);
    procedure AdvMovCupomClick(Sender: TObject);
    procedure AdvSintegraClick(Sender: TObject);
    procedure AdfSpedClick(Sender: TObject);
    procedure AdvChequeClick(Sender: TObject);
    procedure AdvCReceberClick(Sender: TObject);
    procedure AdvCPagarClick(Sender: TObject);
    procedure AdvCaixaClick(Sender: TObject);
    procedure AdvRelCpagClick(Sender: TObject);
    procedure AdvRelCrecClick(Sender: TObject);
    procedure AdvRelOsClick(Sender: TObject);
    procedure AdvRelVendaDivClick(Sender: TObject);
    procedure AdvRelMovCxClick(Sender: TObject);
    procedure AdvRelMovProdClick(Sender: TObject);
    procedure AdvRelCliClick(Sender: TObject);
    procedure AdvRelFornClick(Sender: TObject);
    procedure AdvRelFluxoClick(Sender: TObject);
    procedure AdvParamClick(Sender: TObject);
    procedure AdvAgendaClick(Sender: TObject);
    procedure AdvFazBkpClick(Sender: TObject);
    procedure AdvRecBkpClick(Sender: TObject);
    procedure AdvLmcClick(Sender: TObject);
    ...
    procedure LanaEncerrantes1Click(Sender: TObject);
    procedure AberturaEncerramento1Click(Sender: TObject);
    procedure Lana1Click(Sender: TObject);
    procedure Baixa2Click(Sender: TObject);
    procedure Relatrio1Click(Sender: TObject);
    procedure LMC2Click(Sender: TObject);
    procedure Impresso1Click(Sender: TObject);
    procedure ContasCorrentesClick(Sender: TObject);
    procedure PlanodeContasClick(Sender: TObject);
    procedure AdvCalenderClick(Sender: TObject);
...
//   FHistorico: TStrings;
  ...
  public
    ...
    procedure AcertaPadraoData;External '\siscom\server\dll\ebo7.dll';

    function  NumeroSerieHD : String;External '\siscom\server\dll\ebo7.dll';
    Function  frm(ebo:string): String;External '\siscom\server\dll\ebo7.dll';
var
...
uses backup, restore, modulo, senha, filial, papelparede, cliente,
  ...
  xloc_csosn, PedidoDistruidora, ContaFlex, Combustivel, Tanque, Bombas,
  Bicos, Encerrantes, AberFechLMC, Lanca_credito, BaixaCredito, RelCredito,
  LMC, LMCImpressao, SPEDFISCAL;
...
begin
  ...
  try
    ...
    Backup.BackupFile.Add(ChangeFileExt('\SISCOM\server\bkp\' + FormatDateTime('ddmmyyyy',now), '.fbk'));

    Backup.Active := true;

    listbox1.Clear;
    listbox1.Items.Add(Format('Backup Iniciado às %s horas', [FormatDateTime('hh:nn:ss', now)]));
    listbox1.Items.add('Local: \SISCOM\server\bkp\');
...
begin
  ...
  if FileExists('\\'+frmmodulo.Conexao.HostName+'\Siscom\Server\dll\ECFCom.dll') then
     arquivo := '\\'+frmmodulo.Conexao.HostName+'\Siscom\Server\dll\ECFCom.dll';

  if arquivo = '' then
  begin
    application.messagebox('Não foi possível detectar um compartilhamento válido da pasta SisCom no servidor!'+
                           'Favor compartilhar a pasta SisCom no servidor para prosseguir!','Erro',
                           mb_ok+mb_iconerror);
    application.Terminate;
  end;
  ...
  try
    ...
    if ( res_empresa <> frmmodulo.qremitenteCODIGO.AsString ) or  ( res_rsocial <> copy(frmmodulo.qremitenteNOME.AsString,1,40) ) or  ( res_cnpj <> frmmodulo.qremitenteCNPJ.AsString ) then
      begin
        ...
        DeleteFile('\siscom\server\dll\ECFCom.dll');
        application.terminate;
      end
    else
      begin
...
begin
  ...
  Memo1.Text := '';
  Memo1.Lines.LoadFromFile('\siscom\server\dll\ECFCom.dll');
  Memo1.Lines[0];
...
//     WinExec('cmd /c net share DLL=C:\SISCOM\SERVER\DLL',ERROR_BAD_FORMAT);
//    bativacao.Visible := true;
    ...
    if FileExists('\siscom\server\dll\ECFCom.dll') then
    begin
                       ...
                       begin
{
   ...
   begin
    ...
    try
      ...
      if not Registro.OpenKey('siscom',false) then
      begin
        Registro.CreateKey('siscom');
        Registro.OpenKey('siscom',true);
...
{  getcursorpos(pt);
 ...
 begin
  ...
  Data := DataDeCriacao('C:\siscom\server\siscoms.exe');
...
{  // NÃO SEI PQ ESTÁ REPETIDO ESSE PEDAÇO \\
  ...
  // Rotina adicionada por Valtenci 26.02.2012
//   if frmmodulo.qrconfig.fieldbyname('USAR_LMC').asstring = '1' then
//      begin
//      AdvLmc.Visible := TRUE;
...
//  if frmmodulo.qrconfig.fieldbyname('USAR_LMC').asstring = '0' then
//     begin
//      AdvLmc.Visible := FALSE;
//      frmprincipal.Refresh;
//      frmprincipal.AdvToolBarPager12.Refresh;
//   end;

  //  Esse comando abaixo dá erro pra abrir o paf junto com o siscom server
...
begin
  ...
  begin
    ...
    if Hand = 0 then
    begin
      frmprincipal.ExecutePrograma('\siscom\server\buscapreco\bp.exe','');
    end;
  end;

  Hand := FindWindow('TApplication', 'eBackup');
  if Hand = 0 then
    frmprincipal.ExecutePrograma('\siscom\server\eBackup.exe','');

  Hand := FindWindow('TApplication', 'eFTP');
  if Hand = 0 then
    frmprincipal.ExecutePrograma('\siscom\server\eFTP.exe','');

  Hand := FindWindow('TApplication', 's7servidor');
  if Hand = 0 then
    frmprincipal.ExecutePrograma('\siscom\server\s7servidor.exe','');
...
//  PUTILITARIO.LEFT := 597;
  ...
  if not DirectoryExists('c:\siscom\server\atualizacao') then
    if application.messagebox('Caminho do arquivo para Atualização não encontrado, Deseja Cria-lo?','Aviso',mb_yesno+MB_ICONWARNING) = idyes then
      begin
        ForceDirectories('c:\siscom\server\atualizacao');
        Application.messagebox('Caminho Criado com Sucesso!','Aviso!',mb_ok+MB_ICONQUESTION);
      end;

  assignfile(txt,'\siscom\server\dll\com.ini');
  reset(txt);
  ...
  ExeAtualiza := ExtractFilePath(ParamStr(0))+'atualizacao\siscomS.exe';
  ExeAtual    := ExtractFilePath(ParamStr(0))+'siscomS.exe';
  ...
  if FileExists(ExeAtualiza) then
    begin
      if VersaoExe(ExeAtual) <> VersaoExe(ExeAtualiza) then
        begin
          if Application.messagebox(pchar('Foi Encontrada uma nova versão do Siscom.' + #13 +
...
procedure TfrmPrincipal.AdPedidoDistribuidoraClick(Sender: TObject);
begin
...
procedure TfrmPrincipal.AdvPostoClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'02.08') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
begin
 ...
 try
  assignfile(txt,'\siscom\server\dll\ECFCom.dll');
  rewrite(txt);
...
begin
  ...
  if FileExists('\\'+frmmodulo.Conexao.HostName+'\C\siscom\server\dll\ECFCom.dll') then
     arquivo := '\\'+frmmodulo.Conexao.HostName+'\C\siscom\server\dll\ECFCom.dll';
  ...
  if FileExists('\\'+frmmodulo.Conexao.HostName+'\Siscom\dll\ECFCom.dll') then
     arquivo := '\\'+frmmodulo.Conexao.HostName+'\Siscom\dll\ECFCom.dll';
...
begin
  alerta_copia.CloseDelay := 1;
    ...
    begin
     if  application.MessageBox('Erro ao efetuar backup! Deseja prosseguir a usar o Siscom?','Aviso',mb_yesno+mb_iconwarning) = idno then exit;
    end;
end;
...
begin
  ...
  begin
    ...
    frmprincipal.ExecutePrograma('\siscom\server\sped.exe','');
end;
...
begin
  FrmPedidoDistribuidora := TfrmPedidoDistribuidora.Create(self);
  frmPedidoDistribuidora.ShowModal;   
end;

procedure TfrmPrincipal.AdContaFlexClick(Sender: TObject);
begin
    FrmContaFlex := TFrmContaFlex.Create(self);
    FrmContaFlex.ShowModal;
end;

procedure TfrmPrincipal.spFecharClick(Sender: TObject);
begin
  if application.messagebox('Confirma o encerramento do Sistema?','Aviso',mb_yesno+MB_ICONWARNING) = idyes then
  begin
      frmprincipal.FechePrograma('eBackup');
...
procedure TfrmPrincipal.CadastroEmpresa1Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'01.01') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
begin
//  pop_usuario.Popup(parquivo.left+213,parquivo.top+500);

end;

procedure TfrmPrincipal.CaixaOperadores1Click(Sender: TObject);
begin
  if autentica('Operador de Caixa',4) then
  begin
    FRMCAIXA_OPERADOR := TFRMCAIXA_OPERADOR.CREATE(SELF);
...
procedure TfrmPrincipal.ttt1Click(Sender: TObject);
begin
 WITH FRMPRINCIPAL DO
 BEGIN
...
procedure TfrmPrincipal.FormasdePagamento2Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'01.07') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.tt1Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'03.02') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.CadastrodeGrupos1Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'02.02') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.CadastrodeMarcas1Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'02.03') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.OramentoDiversos1Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'03.03') = 'NAO' then
    begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.CadastrodeOrdemdeServio1Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'03.04') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.NotasDiversasdeVendas1Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'03.05') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.MovimentoDiriodeCupom1Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'03.05') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.GeraoSintegra1Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'03.06') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.GeraoSpedFiscal1Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'03.07') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.ControledeCheques1Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'04.03') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.ContasRecebimentos1Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'04.07') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.ContasaPagamentos1Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'04.02') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.ParametrizaodoSistema1Click(Sender: TObject);
begin
  if frmprincipal.autentica('Configurações',4) then
  begin
    frmconfig := tfrmconfig.create(self);
...
procedure TfrmPrincipal.AgendadeContato1Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'05.03') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.RecuperarBackupdoSistema1Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'05.02') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.FazerBackupdoSistema1Click(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'05.01') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.RelatoriodeContasaPagar1Click(Sender: TObject);
begin
  if nivel_usuario < 3 then
  begin
    Application.MessageBox('Seu nível não permite este acesso!','Atenção',mb_ok+mb_iconwarning);
...
procedure TfrmPrincipal.RelatoriodeContasaReceber1Click(Sender: TObject);
begin
  if nivel_usuario < 3 then
  begin
    Application.MessageBox('Seu nível não permite este acesso!','Atenção',mb_ok+mb_iconwarning);
...
procedure TfrmPrincipal.RelatoriodeOrdemdeServio1Click(Sender: TObject);
begin
  FRMLISTA_OS := TFRMLISTA_OS.CREATE(SELF);
  FRMLISTA_OS.SHOWMODAL;
...
procedure TfrmPrincipal.RelatoriodeVendasDiversas1Click(Sender: TObject);
begin
  if nivel_usuario < 3 then
  begin
    Application.MessageBox('Seu nível não permite este acesso!','Atenção',mb_ok+mb_iconwarning);
...
procedure TfrmPrincipal.RelatoriodeCaixa1Click(Sender: TObject);
begin
  if nivel_usuario < 3 then
  begin
    Application.MessageBox('Seu nível não permite este acesso!','Atenção',mb_ok+mb_iconwarning);
...
procedure TfrmPrincipal.RelatoriodeProdutos1Click(Sender: TObject);
begin
  FRMLISTA_PRODUTO2 := TFRMLISTA_PRODUTO2.CREATE(SELF);
  FRMLISTA_PRODUTO2.SHOWMODAL;
...
procedure TfrmPrincipal.RelatoriodeClientes1Click(Sender: TObject);
begin
  FRMLISTA_CLIENTE2 := TFRMLISTA_CLIENTE2.CREATE(SELF);
  FRMLISTA_CLIENTE2.SHOWMODAL;
...
procedure TfrmPrincipal.RelatoriodeFornecedores1Click(Sender: TObject);
begin
  FRMLISTA_FORNECEDOR2 := TFRMLISTA_FORNECEDOR2.CREATE(SELF);
  FRMLISTA_FORNECEDOR2.SHOWMODAL;
...
procedure TfrmPrincipal.RelatoriodeFluxodeCaixa1Click(Sender: TObject);
begin
  frmfluxo_caixa := tfrmfluxo_caixa.create(self);
  frmfluxo_caixa.showmodal;
...
procedure TfrmPrincipal.AdvSairClick(Sender: TObject);
begin
  if application.messagebox('Confirma o encerramento do Sistema?','Aviso',mb_yesno+MB_ICONWARNING) = idyes then
  begin
      frmprincipal.FechePrograma('eBackup');
...
procedure TfrmPrincipal.AdvEmpresaClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'01.01') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvClientesClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'01.02') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvFornecedorClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'01.03') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvCaixaOperadorClick(Sender: TObject);
begin
  if autentica('Operador de Caixa',4) then
  begin
    FRMCAIXA_OPERADOR := TFRMCAIXA_OPERADOR.CREATE(SELF);
...
procedure TfrmPrincipal.AdvFuncionarioClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'01.05') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvProdutoClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'02.01') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvGrupoClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'02.02') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvMarcaClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'02.03') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvEntradaClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'02.05') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvConsultaPrecoClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'02.08') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvOrcamentoClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'03.03') = 'NAO' then
    begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvOrdemServicoClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'03.04') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvNotaServicoClick(Sender: TObject);
VAR F : TEXTFILE;
slinha : string;
begin
  If frmprincipal.acesso(codigo_usuario,'03.01') = 'NAO' then
...
procedure TfrmPrincipal.AdvConsultaNotaClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'03.05') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvNotaEletronicaClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'03.02') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvMovCupomClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'03.05') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvSintegraClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'03.06') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdfSpedClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'03.07') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvChequeClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'04.03') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvCReceberClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'04.07') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvCPagarClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'04.02') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvCaixaClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'04.01') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvRelCpagClick(Sender: TObject);
begin
  if nivel_usuario < 3 then
  begin
    Application.MessageBox('Seu nível não permite este acesso!','Atenção',mb_ok+mb_iconwarning);
...
procedure TfrmPrincipal.AdvRelCrecClick(Sender: TObject);
begin
  if nivel_usuario < 3 then
  begin
    Application.MessageBox('Seu nível não permite este acesso!','Atenção',mb_ok+mb_iconwarning);
...
procedure TfrmPrincipal.AdvRelOsClick(Sender: TObject);
begin
  FRMLISTA_OS := TFRMLISTA_OS.CREATE(SELF);
  FRMLISTA_OS.SHOWMODAL;
end;

procedure TfrmPrincipal.AdvRelVendaDivClick(Sender: TObject);
begin
  if nivel_usuario < 3 then
  begin
    Application.MessageBox('Seu nível não permite este acesso!','Atenção',mb_ok+mb_iconwarning);
...
procedure TfrmPrincipal.AdvRelMovCxClick(Sender: TObject);
begin
  if nivel_usuario < 3 then
  begin
    Application.MessageBox('Seu nível não permite este acesso!','Atenção',mb_ok+mb_iconwarning);
...
procedure TfrmPrincipal.AdvRelMovProdClick(Sender: TObject);
begin
  FRMLISTA_PRODUTO2 := TFRMLISTA_PRODUTO2.CREATE(SELF);
  FRMLISTA_PRODUTO2.SHOWMODAL;

end;
procedure TfrmPrincipal.AdvRelCliClick(Sender: TObject);
begin
  FRMLISTA_CLIENTE2 := TFRMLISTA_CLIENTE2.CREATE(SELF);
  FRMLISTA_CLIENTE2.SHOWMODAL;
end;

procedure TfrmPrincipal.AdvRelFornClick(Sender: TObject);
begin
  FRMLISTA_FORNECEDOR2 := TFRMLISTA_FORNECEDOR2.CREATE(SELF);
  FRMLISTA_FORNECEDOR2.SHOWMODAL;
end;

procedure TfrmPrincipal.AdvRelFluxoClick(Sender: TObject);
begin
  frmfluxo_caixa := tfrmfluxo_caixa.create(self);
  frmfluxo_caixa.showmodal;
end;

procedure TfrmPrincipal.AdvParamClick(Sender: TObject);
begin
  if frmprincipal.autentica('Configurações',4) then
  begin
    frmconfig := tfrmconfig.create(self);
...
procedure TfrmPrincipal.AdvAgendaClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'05.03') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvFazBkpClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'05.01') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.AdvRecBkpClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'05.02') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
//  frmrestore.showmodal;
//  TAdvGlowButton(sender).setfocus;
winexec('c:\Siscom\Server\bkp.exe',sw_shownormal);
end;

procedure TfrmPrincipal.AdvLmcClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'03.07') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
    ...
    frmprincipal.ExecutePrograma('\siscom\server\LMC\foxlmc.exe','');
end;
...
procedure TfrmPrincipal.Bicos1Click(Sender: TObject);
begin
...
procedure TfrmPrincipal.LanaEncerrantes1Click(Sender: TObject);
begin
   frmEncerrantes := TfrmEncerrantes.Create(self);
   frmEncerrantes.ShowModal;
end;

procedure TfrmPrincipal.AberturaEncerramento1Click(Sender: TObject);
begin
...
procedure TfrmPrincipal.Lana1Click(Sender: TObject);
begin
  frmLancaCredito := tfrmLancaCredito.Create(self);
  frmLancaCredito.ShowModal;

end;

procedure TfrmPrincipal.Baixa2Click(Sender: TObject);
begin
  frmBaixaCredito := tfrmBaixaCredito.Create(self);
  frmBaixaCredito.ShowModal;

end;

procedure TfrmPrincipal.Relatrio1Click(Sender: TObject);
begin
  frmRelCreditos := tfrmRelCreditos.Create(self);
  frmRelCreditos.ShowModal;

end;

procedure TfrmPrincipal.LMC2Click(Sender: TObject);
begin
...
begin
  frmLMCImpressao := tfrmLMCImpressao.Create(self);
  frmLMCImpressao.ShowModal;
end;

procedure TfrmPrincipal.ContasCorrentesClick(Sender: TObject);
begin
  If frmprincipal.acesso(codigo_usuario,'01.08') = 'NAO' then
  begin
    application.messagebox('Acesso não permitido!','Atenção',mb_ok+MB_ICONERROR);
...
procedure TfrmPrincipal.PlanodeContasClick(Sender: TObject);
begin
  frmplano := Tfrmplano.create(self);
  frmplano.SHOWMODAL;
...
procedure TfrmPrincipal.AdvCalenderClick(Sender: TObject);
begin
  frmcalendario := tfrmcalendario.create(self);
  frmcalendario.showmodal;
end;
