...
uses
  ...
  dxRibbonStatusBar, dxCustomTileControl, dxTileControl;
...
//    procedure dxTiledxTileControlItem8Click(Sender: TdxTileControlItem);
 ...
 //     (Sender: TdxTileControlActionBarItem);
    ...
    procedure demoTimer(Sender: TObject);
...
//      Procedure Mensagem(Msg, Titulo: String);
      procedure Aguarde(sTitulo, sTexto: string; FechaAutomatico, bMostra: Boolean; TimeOut: LongInt);
...
uses modulo, senha, filial, papelparede, cliente,
  ...
  form_ativacaoicloud, pUCGeral, OpNatureza, Bicos, LMC, Tanque, AberFechLMC, Bombas, Encerrantes,
  Combustivel, LMCImpressao,  UAguarde, UfrmManifestacao;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          // copia da pasta atualizacao para a pasta Softlogus
...
procedure TfrmPrincipal.demoTimer(Sender: TObject);
begin

    application.messagebox('Essa È um vers„o demo! funciona durante 10mn!', 'AtenÁ„o',
      mb_ok + MB_ICONERROR);

      application.messagebox('Compre os fontes em www.betasoftwares.com.br!', 'AtenÁ„o',
      mb_ok + MB_ICONERROR);
...
begin
WinExec('C:\Softlogus\Server\arquivos\AA_v3.exe', SW_SHOW);
end;
...
procedure TfrmPrincipal.Aguarde(sTitulo, sTexto: string; FechaAutomatico, bMostra: Boolean; TimeOut: LongInt);
begin
