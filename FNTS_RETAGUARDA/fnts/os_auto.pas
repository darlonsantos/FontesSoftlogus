...
uses modulo, loc_funci, principal, loc_cliente, loc_setor,
  ...
  os_contasreceber_auto, cliente_veiculo, xloc_cliente, os_item_2, os_item_3,
  os;
...
begin
  ...
  frmmodulo.qrcliente_VEICULO.Close;
  frmmodulo.qrcliente_VEICULO.sql.clear;
  frmmodulo.qrcliente_VEICULO.sql.add('select * from c000063 where codcliente = ''' + frmmodulo.cdsos.fieldbyname('codcliente').asstring + ''' order by veiculo');
  frmmodulo.qrcliente_VEICULO.open;
...
begin
  ...
  qros_produto.close;
  qros_produto.sql.clear;
  qros_produto.sql.add('select * from c000032 where codnota = ''' +
  frmmodulo.cdsos.fieldbyname('codigo').asstring + ''' and movimento = 9');
  qros_produto.open;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        frmmodulo.qrserial_produto.SQL.Add('update c000022 set situacao = 1, cliente = null, datavenda = null, precovenda = 0 where codproduto = ''' +
         qros_produto.fieldbyname('codproduto').asstring +
          ''' and serial = ''' + qros_produto.fieldbyname('serial').asstring + '''');
    ...
    frmmodulo.cdsos.fieldbyname('produto_subtotal').ASFLOAT :=
     frmmodulo.cdsos.fieldbyname('produto_subtotal').ASFLOAT -
     qros_produto.fieldbyname('total').asfloat;
...
begin
  ...
  frmmodulo.qrcliente_VEICULO.Close;
  frmmodulo.qrcliente_VEICULO.sql.clear;
  frmmodulo.qrcliente_VEICULO.sql.add('select * from c000063 where codcliente = '
  + QuotedStr( frmmodulo.cdsos.fieldbyname('codcliente').asstring )
  + ' order by veiculo');
  frmmodulo.qrcliente_VEICULO.open;
