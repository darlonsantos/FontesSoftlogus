...
type
  Tfrmimporta_nfe = class(TForm)
    ...
    dtmfldDATA_CADASTRO: TDateTimeField;
    wdstrngfldCODGRUPO: TWideStringField;
    wdstrngfldCODSUBGRUPO: TWideStringField;
    wdstrngfldCODFORNECEDOR: TWideStringField;
    wdstrngfldCODMARCA: TWideStringField;
    dtmfldDATA_ULTIMACOMPRA: TDateTimeField;
    wdstrngfldNOTAFISCAL: TWideStringField;
    dtmfldDATA_ULTIMAVENDA: TDateTimeField;
    fltfldESTOQUE: TFloatField;
    fltfldESTOQUEMINIMO: TFloatField;
    wdstrngfldCODALIQUOTA: TWideStringField;
    wdmfldAPLICACAO: TWideMemoField;
    wdstrngfldLOCALICAZAO: TWideStringField;
    fltfldPESO: TFloatField;
    wdstrngfldVALIDADE: TWideStringField;
    fltfldCOMISSAO: TFloatField;
    intgrfldUSA_BALANCA: TIntegerField;
    intgrfldUSA_SERIAL: TIntegerField;
    intgrfldUSA_GRADE: TIntegerField;
    wdstrngfldCODRECEITA: TWideStringField;
    wdstrngfldFOTO: TWideStringField;
    dtmfldDATA_ULTIMACOMPRA_ANTERIOR: TDateTimeField;
    wdstrngfldNOTAFISCAL_ANTERIOR: TWideStringField;
    wdstrngfldCODFORNECEDOR_ANTERIOR: TWideStringField;
    fltfldPRECOCUSTO_ANTERIOR: TFloatField;
    fltfldPRECOVENDA_ANTERIOR: TFloatField;
    fltfldCUSTOMEDIO: TFloatField;
    wdstrngfldAUTO_APLICACAO: TWideStringField;
    wdstrngfldAUTO_COMPLEMENTO: TWideStringField;
    dtmfldDATA_REMARCACAO_CUSTO: TDateTimeField;
    dtmfldDATA_REMARCACAO_VENDA: TDateTimeField;
    fltfldPRECO_PROMOCAO: TFloatField;
    dtmfldDATA_PROMOCAO: TDateTimeField;
    dtmfldFIM_PROMOCAO: TDateTimeField;
    wdstrngfldCLASSIFICACAO_FISCAL: TWideStringField;
    wdstrngfldNBM: TWideStringField;
    wdstrngfldNCM: TWideStringField;
    fltfldIPI: TFloatField;
    fltfldREDUCAO: TFloatField;
    fltfldQTDE_EMBALAGEM: TFloatField;
    wdstrngfldTIPO: TWideStringField;
    fltfldPESO_LIQUIDO: TFloatField;
    wdstrngfldFARMACIA_CONTROLADO: TWideStringField;
    intgrfldFARMACIA_APRESENTACAO: TIntegerField;
    wdstrngfldFARMACIA_REGISTRO_MEDICAMENTO: TWideStringField;
    fltfldFARMACIA_PMC: TFloatField;
    dtmfldULTIMA_ALTERACAO: TDateTimeField;
    dtmfldULTIMA_CARGA: TDateTimeField;
    dtmfldDATA_INVENTARIO: TDateTimeField;
    fltfldCUSTO_INVENTARIO: TFloatField;
    fltfldESTOQUE_INVENTARIO: TFloatField;
    fltfldESTOQUE_ANTERIOR: TFloatField;
    fltfldPRECOVENDA_NOVO: TFloatField;
    intgrfldUSA_RENTABILIDADE: TIntegerField;
    fltfldQUANTIDADE_MINIMA_FAB: TFloatField;
    wdstrngfldAPRESENTACAO: TWideStringField;
    intgrfldSITUACAO: TIntegerField;
    fltfldPRECOVENDA1: TFloatField;
    fltfldPRECOVENDA2: TFloatField;
    fltfldPRECOVENDA3: TFloatField;
    fltfldPRECOVENDA4: TFloatField;
    fltfldPRECOVENDA5: TFloatField;
    fltfldDESCONTO_PRECOVENDA: TFloatField;
    dtmfldDATA_INVENTARIO_ATUAL: TDateTimeField;
    fltfldCUSTO_INVENTARIO_ATUAL: TFloatField;
    fltfldESTOQUE_INVENTARIO_ATUAL: TFloatField;
    fltfldMARGEM_MINIMA: TFloatField;
    wdstrngfldPISCOFINS: TWideStringField;
    wdstrngfldREFERENCIA_FORNECEDOR: TWideStringField;
    fltfldCOMISSAO1: TFloatField;
    fltfldMARGEM_DESCONTO: TFloatField;
    wdstrngfldTAMANHO: TWideStringField;
    wdstrngfldCOR: TWideStringField;
    wdstrngfldINCIDENCIA_PISCOFINS: TWideStringField;
    wdstrngfldVEIC_CHASSI: TWideStringField;
    wdstrngfldVEIC_SERIE: TWideStringField;
    wdstrngfldVEIC_POTENCIA: TWideStringField;
    wdstrngfldVEIC_PESO_LIQUIDO: TWideStringField;
    wdstrngfldVEIC_PESO_BRUTO: TWideStringField;
    wdstrngfldVEIC_TIPO_COMBUSTIVEL: TWideStringField;
    wdstrngfldVEIC_RENAVAM: TWideStringField;
    intgrfldVEIC_ANO_FABRICACAO: TIntegerField;
    intgrfldVEIC_ANO_MODELO: TIntegerField;
    wdstrngfldVEIC_TIPO: TWideStringField;
    wdstrngfldVEIC_TIPO_PINTURA: TWideStringField;
    wdstrngfldVEIC_COD_COR: TWideStringField;
    wdstrngfldVEIC_COR: TWideStringField;
    wdstrngfldVEIC_VIN: TWideStringField;
    wdstrngfldVEIC_NUMERO_MOTOR: TWideStringField;
    wdstrngfldVEIC_CMKG: TWideStringField;
    wdstrngfldVEIC_CM3: TWideStringField;
    wdstrngfldVEIC_DISTANCIA_EIXO: TWideStringField;
    wdstrngfldVEIC_COD_MARCA: TWideStringField;
    wdstrngfldVEIC_ESPECIE: TWideStringField;
    wdstrngfldVEIC_CONDICAO: TWideStringField;
    wdstrngfldLOTE_FABRICACAO: TWideStringField;
    dtmfldLOTE_VALIDADE: TDateTimeField;
    fltfldMARGEM_AGREGADA: TFloatField;
    wdstrngfldCODBARRA_NOVARTIS: TWideStringField;
    wdstrngfldFARMACIA_DCB: TWideStringField;
    wdstrngfldFARMACIA_ABCFARMA: TWideStringField;
    wdstrngfldFARMACIA_APRESENTACAO_CAIXA: TWideStringField;
    wdstrngfldFARMACIA_PRINCIPIOATIVO: TWideStringField;
    dtmfldULTIMA_COMPRA: TDateTimeField;
    dtmfldFARMACIA_DATAVIGENCIA: TDateTimeField;
    wdstrngfldFARMACIA_TIPO: TWideStringField;
    wdstrngfldUSA_COMBUSTIVEL: TWideStringField;
    wdstrngfldREFERENCIA: TWideStringField;
    fltfldPERDA: TFloatField;
    wdstrngfldCOMPOSICAO1: TWideStringField;
    wdstrngfldCOMPOSICAO2: TWideStringField;
    wdstrngfldIAT: TWideStringField;
    wdstrngfldIPPT: TWideStringField;
    wdstrngfldSITUACAO_TRIBUTARIA: TWideStringField;
    wdstrngfldFLAG_SIS: TWideStringField;
    wdstrngfldFLAG_ACEITO: TWideStringField;
    wdstrngfldFLAG_EST: TWideStringField;
    wdstrngfldCSOSN: TWideStringField;
    wdstrngfldCODORIGINAL: TWideStringField;
    fltfldCUSTO_ATACADO: TFloatField;
    wdstrngfldUNIDADE_ATACADO: TWideStringField;
    fltfldQTDE_EMBALAGEMATACADO: TFloatField;
    fltfldPMARGEM1: TFloatField;
    fltfldPMARGEM2: TFloatField;
    fltfldPMARGEM3: TFloatField;
    fltfldPMARGEM4: TFloatField;
    fltfldPMARGEM5: TFloatField;
    fltfldPMARGEMATACADO1: TFloatField;
    fltfldPMARGEMATACADO2: TFloatField;
    fltfldPMARGEMATACADO3: TFloatField;
    fltfldPMARGEMATACADO4: TFloatField;
    fltfldPMARGEMATACADO5: TFloatField;
    fltfldPMARGEMATACADO6: TFloatField;
    fltfldPRECOATACADO1: TFloatField;
    fltfldPRECOATACADO2: TFloatField;
    fltfldPRECOATACADO3: TFloatField;
    fltfldPRECOATACADO4: TFloatField;
    fltfldPRECOATACADO5: TFloatField;
    wdstrngfldIND_CFOP: TWideStringField;
    wdstrngfldCFOP_DESC: TWideStringField;
    intgrfldUSA_LOTE: TIntegerField;
    wdstrngfldIND_CFOP_VENDA_DENTRO: TWideStringField;
    wdstrngfldCODCONTA: TWideStringField;
    wdstrngfldIND_CFOP_VENDA_FORA: TWideStringField;
    wdstrngfldIND_CFOP_DEVOLUCAO_DENTRO: TWideStringField;
    wdstrngfldIND_CFOP_DEVOLUCAO_FORA: TWideStringField;
    wdstrngfldIND_CFOP_GARANTIA_DENTRO: TWideStringField;
    wdstrngfldIND_CFOP_GARANTIA_FORA: TWideStringField;
    wdstrngfldUSA_TB_PC: TWideStringField;
    mmo1: TMemo;
    btn_importar_pela_chave: TAdvGlowButton;
    ...
    procedure btn_importar_pela_chaveClick(Sender: TObject);
  private
...
begin
  ...
  begin
    ...
    begin
     // frmprincipal.Aguarde('Aguarde', 'Importando Itens ' + IntToStr(x + 1) +
      ...
      begin
        ...
        mmo1.lines.add(ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items[x]
          .Prod.med.Items[0].nLote);
        mmo1.lines.add(FloatToStr(ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items
          [x].Prod.med.Items[0].qLote));
        mmo1.lines.add(FloatToStr(ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items
          [x].Prod.med.Items[0].vPMC));
        mmo1.lines.add(DateToStr(ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items
    ...
    mmo1.lines.add('VOLUME----------------------------------');
    mmo1.lines.add('REBOQUE----------------------------------');
...
begin
//mprincipal.Aguarde('Aguarde', 'Faturando nota, efetuando lançamentos....',
  //   False, true, 0);
...
procedure Tfrmimporta_nfe.btn_importar_pela_chaveClick(Sender: TObject);
var
  x, i: integer;
  vid, vnat, vnota, vserie, vcfop, vmodelo, vemissao, vsaida, vuf,
    vcodmunicipio, vdv: string;
         ...
         if AcbrNFe1.WebServices.EnvEvento.EventoRetorno.retEvento.Items[0].RetInfEvento.cStat <> 135 then
          ...
          // OpenDialog1.FileName := ACBrNFe1.Configuracoes.Geral.PathSalvar+'\'+eid.Text;
            ...
            begin
              ...
              {
                mmo1.lines.add('ARMAS----------------------------------');
                mmo1.lines.add(ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items[x].Prod.arma.Items[0].descr);
                mmo1.lines.add(IntToStr(ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items[x].Prod.arma.Items[0].nSerie));
                mmo1.lines.add(IntToStr(ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items[x].Prod.arma.Items[0].nCano));
              }
