...
begin
  ...
  repeat
     ...
     begin
      ...
      sNumero_Cupom := Zerar(FloatToStr( Max('Cupom','Numero','') + 1),6);
     end;
    ...
    begin
      ...
      begin
        ...
        sGRG := Zerar( FloatToStr( max('NAO_FISCAL','GRG','') + 1), 5);
...
begin
  {Anexo VI -  Arquivo eletronico dos registros Efetuados pelo ECF
   ...
   try
    ...
    sNome_Arquivo := '.\Txt\MovtoEcf\'+sECF_Codigo_Sefa+copy(sECF_Serial,length(sECF_serial)-14,14)+
