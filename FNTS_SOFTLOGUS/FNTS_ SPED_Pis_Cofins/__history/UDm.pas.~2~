  ...
  begin
    ...
    begin
      ...
      begin
        ...
        qrProdutos.Next;
        FPrincipal.LbBlocos.Caption := 'BLOCO 0 - 200 > Identificação dos produtos';
        FPrincipal.ProgressBloco.Position := FPrincipal.ProgressBloco.Position + 1;
        FPrincipal.ProgressBar1.Position := FPrincipal.ProgressBar1.Position + 1;
        Application.ProcessMessages;
      end;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if IND_EMIT <> edEmissaoPropria then { só informar os registro 176 se nao for emissao propria }
