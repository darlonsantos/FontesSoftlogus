...
uses principal, modulo, unECF, funcoes, menu_fiscal, StrUtils, UFuncoes;
...
begin
    ...
    begin
      ...
      begin
        ...
        begin
          sGNF := Zerar( FloatToStr( Max('NAO_FISCAL','GNF','') + 1 ),5 );
        ...
        begin
          ...
          spCupom_Forma.close;
          spCupom_Forma.ParamByName('codigo').asstring     := '9' + codifica_forma(1);
          spCupom_Forma.ParamByName('cod_cupom').asstring  := '9' + codifica_cupom;
