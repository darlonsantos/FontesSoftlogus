...
uses
  ...
  AdvOfficeStatusBarStylers, AdvMenuStylers, pngimage, DateUtils;
...
type
  TfrmPrincipal = class(TForm)
    ...
    Panel1: TPanel;
    Image1: TImage;
    VendasPDV1: TMenuItem;
    Registro2: TMenuItem;
    RegistrarSistema1: TMenuItem;
...
var
  ...
  sPortaNaoFiscal:string;     // Porta de Impressora nao Fiscal
...
//  bHabilita_msg := true;
  ...
  // abrir arquivo .ini
  Arquivo_ini := TIniFile.Create('.\cfg\s7Paf.ini');
  ...
  sPasta_foto_produto     := '.\img\produtos';
  sPasta_config           := '.\cfg';
...
begin
  sPortaNaoFiscal := LerArquivoTxt('.cfg\s7.ini','impnaof','LPT1');
  iQtdLinhasFinal := IsInteger(LerArquivoTxt('.cfg\s7.ini','qtdlfin','5'));
            ...
            begin // é nao fiscal ou sem impressora impressora
                ...
                try
                  ...
                  begin
                    ...
                    begin
                     Application.MessageBox(pansichar('As funções de venda serão bloqueadas!'), 'Atenção',mb_ok+mb_iconWarning);
                     bAtiva_Venda := false;
                    end;
