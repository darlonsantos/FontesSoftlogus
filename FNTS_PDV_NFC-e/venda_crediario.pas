...
begin
  ...
  frmvenda.Imprime_display('Informe o CODIGO/CPF ou NOME do cliente',clBackground,tiCliente);
...
begin
  ...
  frmvenda.Imprime_display('Informe a quantidade de prestações',clBackground,tiCliente);
...
begin
  frmvenda.Imprime_display('ENTER confirmar o cliente!',clBackground,tiCliente);
end;

// -------------------------------------------------------------------------- //
procedure TfrmVenda_Crediario.bt_cancelar_crediarioEnter(Sender: TObject);
begin
  frmvenda.Imprime_display('ENTER cancelar o crediário!',clBackground,tiCliente);
end;
