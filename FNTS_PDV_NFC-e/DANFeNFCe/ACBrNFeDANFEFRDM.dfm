object dmACBrNFeFR: TdmACBrNFeFR
  ...
  object cdsCalculoImposto: TClientDataSet
    ...
    object cdsCalculoImpostovTroco: TCurrencyField
      FieldName = 'vTroco'
    end
    object cdsCalculoImpostovTotPago: TCurrencyField
      FieldName = 'vTotPago'
    end
  end
  ...
  object frxReport: TfrxReport
    ...
    PreviewOptions.Buttons = [pbPrint, pbZoom, pbFind, pbPageSetup, pbNavigator, pbExportQuick]
    PreviewOptions.Zoom = 1.000000000000000000
    PrintOptions.Printer = 'Default'
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 40401.475989294000000000
    ReportOptions.LastChange = 41582.574247870400000000
