...
begin
  ...
  frmvenda.Imprime_display('Informe o nome do cliente',clBackground,tiCliente);
...
begin
  ...
  frmvenda.Imprime_display('Informe o endereço do cliente',clBackground,tiCliente);
  if iTeclado_modelo = 1 then
  begin
     blimpa_edit_display := true;
...
begin
  ...
  frmvenda.Imprime_display('Informe a cidade do cliente',clBackground,tiCliente);
  if iTeclado_modelo = 1 then
  begin
     blimpa_edit_display := true;
...
begin
  ...
  frmvenda.Imprime_display('Informe o estado do cliente',clBackground,tiCliente);
  if iTeclado_modelo = 1 then
  begin
     blimpa_edit_display := true;
...
begin
  ...
  frmvenda.Imprime_display('Informe o cep do cliente',clBackground,tiCliente);
  if iTeclado_modelo = 1 then
  begin
     blimpa_edit_display := true;
...
begin
  ...
  frmvenda.Imprime_display('Informe o CPF/CNPJ do cliente',clBackground,tiCliente);
  if iTeclado_modelo = 1 then
  begin
     blimpa_edit_display := true;
...
begin
  ...
  frmvenda.Imprime_display('Informe o Km do veículo do cliente',clBackground,tiCliente);
  if iTeclado_modelo = 1 then
  begin
     blimpa_edit_display := true;
...
begin
  ...
  frmvenda.Imprime_display('Informe a placa do veículo do cliente',clBackground,tiCliente);
  if iTeclado_modelo = 1 then
  begin
     blimpa_edit_display := true;
...
begin
  ...
  frmvenda.Imprime_display('Informe o vendedor deste cupom',clBackground,tiCliente);
  if iTeclado_modelo = 1 then
  begin
     blimpa_edit_display := true;
...
begin
  frmvenda.Imprime_display('ENTER para confirmar o consumidor',clBackground,tiCliente);
end;

// -------------------------------------------------------------------------- //
procedure TfrmConsumidor.bt_cancelar_consumidEnter(Sender: TObject);
begin
  frmvenda.Imprime_display('ENTER para cancelar o consumidor',clBackground,tiCliente);
end;
