...
begin
  frmvenda.Imprime_display('Informe o vendedor (Codigo/Nome)',clBackground, tiCliente);
...
begin
  frmvenda.Imprime_display('ENTER para confirmar o vendedor',clBackground,tiCliente);
end;

// -------------------------------------------------------------------------- //
procedure TfrmVendedor.btnCancelarEnter(Sender: TObject);
begin
  frmvenda.Imprime_display('ENTER para cancelar o vendedor',clBackground,tiCliente);
end;
