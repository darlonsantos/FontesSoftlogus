...
begin
  ...
  begin
    ...
    if frmnotafiscal_menu.qrempresa.fieldbyname('uf').asstring <> frmmodulo.qrclienteUF.asstring then
          begin
             if (frmnotafiscal_menu.qrnota.fieldbyname('PFCPUFDEST').asfloat > 0) or (frmnotafiscal_menu.qrnota.fieldbyname('PICMSUFDEST').asfloat > 0) or (frmnotafiscal_menu.qrnota.fieldbyname('PICMSINTER').asfloat > 0) then
               begin

            frmnotafiscal_menu.qrnota.fieldbyname('VBCUFDEST').asfloat :=
            frmnotafiscal_menu.qrnota.fieldbyname('BASE_CALCULO').asfloat;


                 frmnotafiscal_menu.qrnota.fieldbyname('VFCPUFDEST').asfloat :=
                  frmnotafiscal_menu.qrnota.fieldbyname('VBCUFDEST').asfloat*(frmnotafiscal_menu.qrnota.fieldbyname('PFCPUFDEST').asfloat/100);

              frmnotafiscal_menu.qrnota.fieldbyname('DIFAL').asfloat := frmnotafiscal_menu.qrnota.fieldbyname('VBCUFDEST').asfloat *
              ((frmnotafiscal_menu.qrnota.fieldbyname('PICMSUFDEST').asfloat -
              frmnotafiscal_menu.qrnota.fieldbyname('PICMSINTER').asfloat) /100);

            {  case strtoint(FormatDateTime('yyyy', Date )) of
                   2016 :  frmnotafiscal_menu.qrnota.fieldbyname('VICMSUFREMET').asfloat  :=  frmnotafiscal_menu.qrnota.fieldbyname('DIFAL').asfloat * (60.00/100);
                   2017 :  frmnotafiscal_menu.qrnota.fieldbyname('VICMSUFREMET').asfloat  :=  frmnotafiscal_menu.qrnota.fieldbyname('DIFAL').asfloat * (40.00/100);
                   2018 :  frmnotafiscal_menu.qrnota.fieldbyname('VICMSUFREMET').asfloat  :=  frmnotafiscal_menu.qrnota.fieldbyname('DIFAL').asfloat * (20.00/100);
                   else  frmnotafiscal_menu.qrnota.fieldbyname('VICMSUFREMET').asfloat  :=  frmnotafiscal_menu.qrnota.fieldbyname('DIFAL').asfloat * (100.00/100);
              end; }

              IF strtoint(FormatDateTime('yyyy', Date )) = 2016 THEN
              BEGIN
                   frmnotafiscal_menu.qrnota.fieldbyname('VICMSUFREMET').asfloat  :=
                   frmnotafiscal_menu.qrnota.fieldbyname('DIFAL').asfloat * 0.6;
                   frmnotafiscal_menu.qrnota.fieldbyname('VICMSUFDEST').asfloat  :=
                   frmnotafiscal_menu.qrnota.fieldbyname('DIFAL').asfloat * 0.4;

              END
              else IF strtoint(FormatDateTime('yyyy', Date )) = 2017 THEN
              BEGIN
                   frmnotafiscal_menu.qrnota.fieldbyname('VICMSUFREMET').asfloat  :=
                   frmnotafiscal_menu.qrnota.fieldbyname('DIFAL').asfloat * 0.4;
                   frmnotafiscal_menu.qrnota.fieldbyname('VICMSUFDEST').asfloat  :=
                   frmnotafiscal_menu.qrnota.fieldbyname('DIFAL').asfloat * 0.6;
              END
              else IF strtoint(FormatDateTime('yyyy', Date )) = 2018 THEN
              BEGIN
                   frmnotafiscal_menu.qrnota.fieldbyname('VICMSUFREMET').asfloat  :=
                   frmnotafiscal_menu.qrnota.fieldbyname('DIFAL').asfloat * 0.2;
                   frmnotafiscal_menu.qrnota.fieldbyname('VICMSUFDEST').asfloat  :=
                   frmnotafiscal_menu.qrnota.fieldbyname('DIFAL').asfloat * 0.8;
              END
               else
              BEGIN
                   frmnotafiscal_menu.qrnota.fieldbyname('VICMSUFDEST').asfloat  :=
                   frmnotafiscal_menu.qrnota.fieldbyname('DIFAL').asfloat;
              END;
  ...
  begin
    ...
    frmnotafiscal_menu.qrnota.FieldByName('VALOR_PRODUTOS').asfloat := vtot_produtos;
     ...
     if (frmnotafiscal_menu.qrempresa.fieldbyname('uf').asstring <> frmmodulo.qrclienteUF.asstring) AND (frmmodulo.qrclienteTIPO.AsInteger = 1) then
          begin
             if (frmnotafiscal_menu.qrnota.fieldbyname('PFCPUFDEST').asfloat > 0) or (frmnotafiscal_menu.qrnota.fieldbyname('PICMSUFDEST').asfloat > 0) or (frmnotafiscal_menu.qrnota.fieldbyname('PICMSINTER').asfloat > 0) then
               begin
              ...
              begin
                    application.messagebox('Erro nas aliquitas do difal, verifique o cadastro do cliente!', 'Aviso', mb_ok + mb_iconwarning);
              end;
        end;
  ...
  if ed_desconto.Value <> vdesconto_anterior then
    frmnotafiscal_menu.qrnota.FieldByName('DESCONTO').asfloat := (frmnotafiscal_menu.qrnota.FieldByName('DESCONTO').asfloat +
      ...
      if frmnotafiscal_menu.qrempresa.fieldbyname('uf').asstring <> frmmodulo.qrclienteUF.asstring then
      begin
      frmnotafiscal_menu.qrnota.fieldbyname('VFCPUFDESTTOTAL').asfloat  :=   frmnotafiscal_menu.qrnota.fieldbyname('VFCPUFDEST').asfloat;
      frmnotafiscal_menu.qrnota.fieldbyname('VICMSUFDESTTOTAL').asfloat  :=   frmnotafiscal_menu.qrnota.fieldbyname('VICMSUFREMET').asfloat;
      frmnotafiscal_menu.qrnota.fieldbyname('VICMSUFREMETTOTAL').asfloat  := frmnotafiscal_menu.qrnota.fieldbyname('VICMSUFDEST').asfloat ;
      end;
