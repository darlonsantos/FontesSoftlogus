...
uses venda, modulo, principal, venda_contasreceber, troco, venda_impressao,
  ...
  cartao_ficha, OpNatureza, UFuncoes, venda_item_2;
  ...
  //  frmmodulo.boleto.Imprimir;
    ...
    begin
      ...
      IBQuery1.params.parambyname('xcodbarra').asstring :=
        ...
        // itamar
        IBQuery1.params.parambyname('cor').asstring :=
            frmvenda.qrvenda_produto.FieldByName('cor').asstring;
        //frmvenda.edit_cor.Text;
        IBQuery1.params.parambyname('tamanho').asstring :=
            frmvenda.qrvenda_produto.FieldByName('tamanho').asstring;
//frmvenda.edit_tamanho.Text;
