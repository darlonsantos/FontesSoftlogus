...
uses
// DARLON SANTOS
  Classes, Vcl.Controls, DesignEditors, DesignIntf,  TypInfo, UCBase, ToolsApi, Windows, vcl.Graphics;
...
uses
  VCL.Dialogs, VCL.Forms, SysUtils, UCAbout, UCIdle, UCObjSel_U, UCEditorForm_U, VCL.ActnList,
  VCL.ActnMan, VCL.ActnMenus, VCL.Menus, VCL.StdCtrls, UCSettings, Variants, UcMail, UcConsts_Language;
