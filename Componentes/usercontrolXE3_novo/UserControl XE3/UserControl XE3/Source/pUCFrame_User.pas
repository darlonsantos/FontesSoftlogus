...
type
  TUCFrame_User = class(TFrame)
    ...
    btAdic889: TBitBtn;
    BtAlt112: TBitBtn;
    BtExclui7789: TBitBtn;
    BtAcess752: TBitBtn;
    BtPass1002: TBitBtn;
    DbGridUser: TDBGrid;
    DataUser:   TDataSource;
    DataPerfil: TDataSource;
    btAdic: TAdvGlowButton;
    BtAlt: TAdvGlowButton;
    BtExclui: TAdvGlowButton;
    BtPass: TAdvGlowButton;
    BtAcess: TAdvGlowButton;
    procedure btAdic889Click(Sender: TObject);
    procedure BtAlt112Click(Sender: TObject);
    procedure BtAcess752Click(Sender: TObject);
    procedure BtPass1002Click(Sender: TObject);
    procedure BtExclui7789Click(Sender: TObject);
  protected
...
procedure TUCFrame_User.btAdic889Click(Sender: TObject);
begin
...
procedure TUCFrame_User.BtAlt112Click(Sender: TObject);
begin
...
procedure TUCFrame_User.BtExclui7789Click(Sender: TObject);
var
  TempID:    Integer;
  CanDelete: Boolean;
  ErrorMsg:  String;
...
procedure TUCFrame_User.BtPass1002Click(Sender: TObject);
begin
  if FDataSetCadastroUsuario.IsEmpty then
    Exit;
...
procedure TUCFrame_User.BtAcess752Click(Sender: TObject);
var
  formHandle: THandle;
begin
