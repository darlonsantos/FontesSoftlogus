...
type
  TUCFrame_Log = class(TFrame)
    ...
    procedure btexclui88Click(Sender: TObject);
    procedure Data1Change(Sender: TObject);
    procedure btfiltro123Click(Sender: TObject);
  private
...
procedure TUCFrame_Log.btexclui88Click(Sender: TObject);
var
  FTabLog, Temp: String;
begin
  // modified by fduenas
...
procedure TUCFrame_Log.btfiltro123Click(Sender: TObject);
begin
  AplicaFiltro;
end;
