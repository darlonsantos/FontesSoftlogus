...
type
  TUCFrame_UsersLogged = class(TFrame)
    ...
    Panel3:     TPanel;
    BitMsg36: TBitBtn;
    BitRefresh458: TBitBtn;
    BitMsg: TAdvGlowButton;
    BitRefresh: TAdvGlowButton;
    procedure BitRefresh458Click(Sender: TObject);
    procedure BitMsg36Click(Sender: TObject);
  private
...
procedure TUCFrame_UsersLogged.BitRefresh458Click(Sender: TObject);
begin
  try
...
procedure TUCFrame_UsersLogged.BitMsg36Click(Sender: TObject);
var
  Msg: String;
begin
