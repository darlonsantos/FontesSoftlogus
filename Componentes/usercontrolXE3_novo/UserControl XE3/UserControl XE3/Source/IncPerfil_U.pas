...
type
  TfrmIncluirPerfil = class(TForm)
    ...
    procedure btCancela9999Click(Sender: TObject);
    procedure btGravar555Click(Sender: TObject);
...
procedure TfrmIncluirPerfil.btCancela9999Click(Sender: TObject);
begin
  Close;
end;

procedure TfrmIncluirPerfil.btGravar555Click(Sender: TObject);
begin
