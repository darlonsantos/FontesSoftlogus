...
type
  ...
  TfrmPrincipal = class(TForm)
    ...
    wwDBGrid1: TwwDBGrid;
    qrniverNOME: TWideStringField;
    qrniverNASCIMENTO: TWideStringField;
    qrniverTELEFONE1: TWideStringField;
    qrniverCELULAR: TWideStringField;
    lsit_caixa: TLabel;
    lcaixa: TLabel;
    ...
    Label1: TLabel;
    Label2: TLabel;
    advsmthbtnAction9: TAdvSmoothButton;
    advsmthbtnAction43: TAdvSmoothButton;
    advsmthbtnAction10: TAdvSmoothButton;
    advsmthbtnAction50: TAdvSmoothButton;
    advsmthbtnAction11: TAdvSmoothButton;
    advsmthbtnAction49: TAdvSmoothButton;
    advsmthbtnAction4: TAdvSmoothButton;
    advsmthbtnAction5: TAdvSmoothButton;
    S8: TMenuItem;
    R2: TMenuItem;
...
procedure TfrmPrincipal.N9Click(Sender: TObject);
begin
AdvSmoothPanel5.Show;
end;
...
begin
    Statusbar1.Panels [0].Text := 'Usu·rio Logado : '+ iCloud.CurrentUser.UserLogin; //Mostrar Login
    Statusbar1.Panels [1].Text := 'Empresa : '+ Label6.Caption;//para hora
    Statusbar1.Panels [2].Text := 'Servidor : '+ Label11.Caption;//para hora
    Statusbar1.Panels [3].Text := 'Data : '+datetostr(date);// para data
    Statusbar1.Panels [4].Text := 'Hora : '+timetostr(now);//para hora
end;
...
begin
 ...
 //informaÁıes sobre licensa do sistema.
   Form_ativar.label1.Caption := '';
   Form_ativar.label1.Caption := 'N˙mero de Registro∫ :................. '+ IntToStr(frmPrincipal.store_protect.IDInstalacao) + #13;
  ...
  // InformaÁıes caso seja demonstraÁ„o
   if frmPrincipal.store_protect.Sistema_DemoU then
         Form_ativar.label1.Caption := Form_ativar.label1.Caption + 'EM FAZE DE TESTES'
   else
         Form_ativar.label1.Caption := Form_ativar.label1.Caption + 'LICENSA ATIVADA COM SUCESSO';
 ...
 //fim
  ...
  begin
     //showmessage('sistema È uma estacao');
    FHoje := Trunc(date);
  ...
  try
    ...
    if not Registro.OpenKey('D S A - Erp', false) then
    begin
      Registro.CreateKey('D S A - Erp');
      Registro.OpenKey('D S A - Erp', true);
    ...
    Registro.Free;
       ...
       // ConfiguraÁıes de Ramos no Status bar
  frmmodulo.QRCONFIG.open;
  case frmmodulo.QRCONFIG.FIELDBYNAME('RAMO_ATIVIDADE').AsInteger of
    1:
      begin // FULL
        // Statusbar1.Panels[5].Text := 'Ramo de Atividade: FULL';
      end;
    2:
      begin // SUPERMERCADO
        // Statusbar1.Panels[5].Text := 'Ramo de Atividade: SUPER';
      end;
    3:
      begin // PECAS
       //  Statusbar1.Panels[5].Text := 'Ramo de Atividade: PE«AS';
      end;
    4:
      begin // FARMACIA
        // Statusbar1.Panels[5].Text := 'Ramo de Atividade: FARMACIA';
      end;
  end;
  ...
  begin
    ...
    data := DataDeCriacao(extractfilepath(paramstr(0)) +'Gerencial.exe');
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        if application.messagebox
          (Pchar('Foi Encontrada uma nova vers„o do Sistema.' + #13 +
        ...
        begin
          ...
          Hand := FindWindow('TApplication', 'Gerencial - Controle de Loja | www.dsainfosys.com.br |');
          if Hand = 0 then
...
procedure TfrmPrincipal.C21Click(Sender: TObject);
begin
...
procedure TfrmPrincipal.AtualizarExecute(Sender: TObject);
begin
 qrcx.close;
  qrcx.SQL.clear;
  qrcx.SQL.add('select * from c000045 where codigo = ''000099''');
