...
begin
   frmPrincipal.store_protect.renovar;
     Label1.Caption := '';
   Label1.Caption := 'Número de Registro : '+ IntToStr(frmPrincipal.store_protect.IDInstalacao) + #13;
  ...
  // Label1.Caption := Label1.Caption + 'Versão : ' + IntToStr(frmPrincipal.store_protect.Versao_Sistema )+ #13;
   if frmPrincipal.store_protect.Sistema_DemoU then
         Label1.Caption := Label1.Caption + 'EM FAZE DE TESTES'
   else
         Label1.Caption := Label1.Caption + 'LICENSA ATIVADA COM SUCESSO'
end;
