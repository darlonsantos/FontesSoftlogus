object frmxloc_modelo: Tfrmxloc_modelo
  ...
  object AdvSmoothExpanderPanel1: TAdvSmoothExpanderPanel
    ...
    Fill.ShadowOffset = 0
    Fill.Glow = gmNone
    Fill.GlowGradientColor = clHighlight
    Fill.GlowRadialColor = clHighlight
    Version = '1.1.0.0'
    Align = alTop
    TabOrder = 2
    ShowExpander = False
    ExpanderColor = clHighlight
    ExpanderDownColor = clHighlight
    ExpanderHoverColor = clHighlight
    ExplicitTop = 1
    TMSStyle = 0
