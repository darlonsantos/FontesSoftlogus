object frmimporta_nfe: Tfrmimporta_nfe
  ...
  object RzPanel1: TRzPanel
    ...
    BorderHighlight = clHighlight
    BorderShadow = clHighlight
    BorderWidth = 2
    Color = clHighlight
    ...
    object TabSheet1: TRzTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        ControlType.Strings = (
          ...
          'UNITARIO;CustomEdit;wwDBEdit1;F')
        PictureMasks.Strings = (
          'PMARGEM'#9'#.##0'#9'T'#9'T'
          'PRECOVENDA'#9'#,##0.00'#9'T'#9'T'
          'UNITARIO'#9'#,##0.00'#9'T'#9'T')
        Selected.Strings = (
          'chave'#9'3'#9'X'#9'F'
          'CODBARRA'#9'14'#9'COD. BARRA'#9'T'
          'ITEM'#9'3'#9'ITEM'#9'T'
          'CODPRODUTO'#9'6'#9'C'#211'DIGO'#9'T'#9'PRODUTO'
          'PRODUTO'#9'46'#9'PRODUTO'#9'T'
          'UN_COMPRA'#9'2'#9'UN'#9'T'#9'PRODUTO'
          'CST'#9'3'#9'CST'#9'T'#9'INF.FISCAIS'
          'CFOP'#9'4'#9'CFOP'#9'T'#9'INF.FISCAIS'
          'ICMS_ALIQUOTA'#9'5'#9'ICMS'#9'T'#9'INF.FISCAIS'
          'IPI_ALIQUOTA'#9'5'#9'IPI'#9'T'#9'INF.FISCAIS'
          'QTDE'#9'10'#9'QTDE'#9'T'#9'TOTAIS'
          'UNITARIO'#9'10'#9'UNIT'#193'RIO'#9'T'#9'TOTAIS'
          'SUBTOTAL'#9'10'#9'SUBTOTAL'#9'T'#9'TOTAIS'
          'DESCONTO'#9'7'#9'DESC.'#9'T'#9'TOTAIS'
          'TOTAL'#9'10'#9'TOTAL'#9'T'#9'TOTAIS'
          'FRACAO'#9'3'#9'FRA'#199#195'O'#9'F'
          'PMARGEM'#9'10'#9'PMARGEM'#9'F'
          'PRECOVENDA'#9'10'#9'PRE'#199'O DE VENDA'#9'F')
  ...
  object AdvSmoothExpanderPanel1: TAdvSmoothExpanderPanel
    ...
    object Label53: TLabel
      ...
      Width = 485
      Height = 23
      Caption = 'Aqui voc'#234' ir'#225' importar as Notas Fiscais de Entrada'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -19
      Font.Name = 'Verdana'
  ...
  object ImageList1: TImageList
    ...
    Top = 504
    Bitmap = {
      494C01010200040048000F000F00FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
