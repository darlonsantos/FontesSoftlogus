...
type
  Tfrmcontasreceber = class(TForm)
    ...
    BGRAVARbalterar: TAdvGlowButton;
    BGRAVARbexcluir: TAdvGlowButton;
    BGRAVARbextornar: TAdvGlowButton;
    ...
    procedure BGRAVARbextornarClick(Sender: TObject);
    ...
    procedure BGRAVARbalterarClick(Sender: TObject);
    procedure BGRAVARbrenegociarClick(Sender: TObject);
...
procedure Tfrmcontasreceber.BGRAVARbliquidarClick(Sender: TObject);
begin
  QRCr.First;
  rselecao.Value := 0;
  total_original := 0;
...
procedure Tfrmcontasreceber.BGRAVARbexcluirClick(Sender: TObject);
var
...
procedure Tfrmcontasreceber.BGRAVARbextornarClick(Sender: TObject);
var
  rec: integer;
  tot: real;
  nome_cliente: string;
...
procedure Tfrmcontasreceber.BGRAVARbalterarClick(Sender: TObject);
begin
  if QRCr.RecordCount = 0 then
  begin
    application.messagebox('Não tem nenhuma conta selecionada!', 'Atenção',
...
procedure Tfrmcontasreceber.BGRAVARbrenegociarClick(Sender: TObject);
var
  nome_cliente: string;
begin
  nome_cliente := copy(frmmodulo.qrcliente.Fieldbyname('nome').asstring, 1, 40);
...
procedure Tfrmcontasreceber.BGRAVAR3Click(Sender: TObject);
begin
