...
uses
  ...
  ACBrBoletoFCFR, ACBrBase; // NeoKeyUnit,frxExportImage,frxExportRTF,
...
type
  Tfrmmodulo = class(TDataModule)
    ...
    qrvendaCODFILIAL: TWideStringField;
    qrvendaCODLOCAL: TWideStringField;
...
var
  ...
  porta, i: Integer;
begin
    // FUNCAO PARA PROTECAO NEOKEY na versao 2.0 do Softlogus
  begin
    // LOGIN
...
//  if ShortDateFormat <> 'dd/MM/yyyy' then
  ...
  caminho := '\Softlogus\server\ini\com.ini'; // Abre o Sistema Atual
    ...
    begin
      if trim(copy(entrada, 9, 50)) = 'LOCALHOST' then
        frmprincipal.caption :=
          'Softlogus | www.softlogus.com.br |'
      else
        frmprincipal.caption :=
          'Softlogus | www.softlogus.com.br |                 [ Servidor: ' +
