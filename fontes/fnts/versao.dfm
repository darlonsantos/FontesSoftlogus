object frmVersao: TfrmVersao
  ...
  object edtUrl: TEdit
    ...
    Enabled = False
    TabOrder = 3
    Text = 'http://www.softlogus.com.br/versao/RETARGUARDA/Softlogus.exe'
    Visible = False
  end
  object sophiaSoares: TIdHTTP
    OnWork = sophiaSoaresWork
    OnWorkBegin = sophiaSoaresWorkBegin
    OnWorkEnd = sophiaSoaresWorkEnd
    AllowCookies = True
  ...
  object dlgSave: TSaveDialog
    InitialDir = 'C:\Softlogus\Server\atualizacao'
