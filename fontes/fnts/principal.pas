...
begin
 ...
 Form_ativar.label1.Caption := '';
  ...
  try
    ...
    if not Registro.OpenKey('Softlogus - Erp', false) then
    begin
      Registro.CreateKey('Softlogus - Erp');
      Registro.OpenKey('Softlogus - Erp', true);
...
begin
  barra_config.Visible:= False;
  if frmPrincipal.autentica('AtualizaÁıes', 4) then
  begin
