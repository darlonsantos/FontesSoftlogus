...
//                  frmloc_venda_produto_auto.ShowModal;
      ...
      begin
        ...
        begin
          ...
          edit_cor.text := qrproduto.FieldByName('cor').asstring;
          edit_tamanho.text := qrproduto.FieldByName('tamanho').AsString;
...
begin
  ...
  begin
    ...
    item := item + 1;
      // itamar
          FRMVENDA.qrvenda_produto.FieldByName('cor').AsString := edit_cor.text;
//          FRMVENDA.qrvenda_produto.FieldByName('cor').AsString;

          FRMVENDA.qrvenda_produto.FieldByName('tamanho').AsString := edit_tamanho.text;
