          ...
          begin
            ...
            begin
              ...
              while not qrpdv.eof do begin
                qrServidor.SQL.Add('insert into NFCE (NUMERO, DATA, TOTAL, CLIENTE, CHAVE, XML, SITUACAO, TROCO, CONTINGENCIA, ENVIADOCONTINGENCIA, MOTIVOCONTIGENCIA, XMLENVIO, XMLCACNELAMENTO, HORA, XML_CANCELAMENTO) VALUES');
                qrServidor.SQL.Add( '(:NUMERO, :DATA, :TOTAL, :CLIENTE, :CHAVE, :XML, :SITUACAO, :TROCO, :CONTINGENCIA, :ENVIADOCONTINGENCIA, :MOTIVOCONTIGENCIA, :XMLENVIO, :XMLCACNELAMENTO, :HORA, :XML_CANCELAMENTO)');
                ...
                qrServidor.Params.ParamByName('XML_CANCELAMENTO').AsString := qrpdv.FieldByName('XML_CANCELAMENTO').AsString;
                qrServidor.ExecSQL;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if LimpaDados then begin
              memo1.lines.add('PDV' + grid.CELL[0, I].ASSTRING + ' - DEL - CARTÃO/FINANCEIRA');
              try
                qrpdv.close;
                qrpdv.sql.clear;
                ...
                on E: Exception do
                begin
                  memo1.lines.add('PDV' + grid.CELL[0, I].ASSTRING + ' ERRO - DEL - CARTÃO/FINANCEIRA');
                  Memo1.LINES.Add('Mensagem: ' + E.message);
                end;
              end;
            end;
